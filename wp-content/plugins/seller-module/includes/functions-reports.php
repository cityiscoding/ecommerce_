...
function dokan_seller_sales_statement() {
    ...
    <table class="table table-striped">
        <thead>
        <tr>
            <th><?php esc_html_e( 'Ngày chốt sổ', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Ngày giao dịch', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'ID', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Type', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Ghi nợ', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Tín dụng', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Số dư', 'dokan' ); ?></th>
        </tr>
        </thead>
        <tbody>
...
function dokan_sales_overview() {
    ...
    $sales_by_date->heading    =  __( 'Doanh số tháng này', 'dokan' );
...
function dokan_daily_sales() {
    ...
    $sales_by_date = new \WeDevs\DokanPro\Reports\SalesByDate();
    $sales_by_date->heading    =  __( 'Doanh số theo ngày', 'dokan' );
    $sales_by_date->current_range = 'month';
...
function dokan_top_sellers() {
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <th><?php esc_html_e( 'Doanh số', 'dokan' ); ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
...
function dokan_top_earners() {
    ...
    <table class="table table-striped">
        ...
        <tr>
            <th><?php esc_html_e( 'Sản phẩm', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Doanh số', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Lợi nhuận', 'dokan' ); ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
