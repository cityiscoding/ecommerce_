...
<div class="commission show_if_simple show_if_variable show_if_booking">
  <p class="form-field dimensions_field">
    ...
    <span class="wrapper">
      <input id="admin_commission" class="input-text <?php echo $wc_input_class; ?>" type="text"
        name="_per_product_admin_commission" value="<?php echo $admin_commission; ?>">
      <span class="additional_fee dokan-hide">
        <?php echo esc_html( '% &nbsp;&nbsp; +' ); ?>
        <input class="input-text wc_input_price" type="text" name="_per_product_admin_additional_fee"
          value="<?php echo wc_format_localized_price( $additional_fee ); ?>">
      </span>
    ...
    public function product_row_action( $row_action, $post ) {
        ...
        if ( current_user_can( 'dokan_edit_product' ) ) {
            $row_action['quick-edit'] = array(
                'title' => __( 'Chỉnh sửa nhanh', 'dokan' ),
                'url'   => '#quick-edit',
