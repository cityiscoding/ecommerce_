    ...
    public function load_settings_helper_text( $help_text, $query_vars ) {
        ...
        if ( $query_vars == 'shipping' ) {
            ...
            $help_text = sprintf ( '<p>%s</p>',
                __( 'Khu vực vận chuyển là một khu vực địa lý nơi cung cấp một số phương thức vận chuyển nhất định. Chúng tôi sẽ kết nối khách hàng với một khu vực bằng cách sử dụng địa chỉ giao hàng của họ và trình bày các phương thức giao hàng trong khu vực đó cho họ.', 'dokan' ),
