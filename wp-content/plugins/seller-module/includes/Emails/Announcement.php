...
class Announcement extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title            = __( 'PallMall Thông báo', 'dokan' );
        $this->description      = __( 'Email gửi thông báo đến người bán được chọn hay toàn bộ ', 'dokan' );
    ...
    public function get_default_subject() {
        return __( 'Một thông báo mới được tạo ra tại - {site_name}', 'dokan' );
    }
    ...
    public function get_default_heading() {
        return __( 'Thông báo mới - {title}', 'dokan' );
    }
