...
class VendorEnable extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'PallMall Nhà cung cấp được kích hoạt', 'dokan' );
        $this->description    = __( 'Email này được gữi cho nhà cung cấp khi được kích hoạt từ cài đặt quản trị viên', 'dokan' );
    ...
    public function get_default_subject() {
        return __( '[{site_name}] Tài khoản của bạn được kích hoạt', 'dokan' );
    }
    ...
    public function get_default_heading() {
        return __( 'Tài khoản nhà cung cấp của bạn được kích hoạt', 'dokan' );
    }
