...
class RefundVendor extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'PallMall xử lý hoàn tiền', 'dokan' );
        $this->description    = __( 'Những email này được gửi đến nhà cung cấp khi yêu cầu hoàn tiền của nhà cung cấp được xử lý', 'dokan' );
    ...
    public function get_default_subject() {
        return __( '[{site_name}] Yêu cầu hoàn lại của bạn là {status}', 'dokan' );
    }
    ...
    public function get_default_heading() {
        return __( 'Yêu cầu hoàn lại tiền cho {order_id} & {status}', 'dokan' );
    }
