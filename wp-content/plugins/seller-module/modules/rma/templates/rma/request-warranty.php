...
<h3>
  <?php esc_html_e( 'Tên cửa hàng: ', 'dokan' ); ?>
...
<form method="post">
  <table class="woocommerce-orders-table shop_table shop_table_responsive dokan-rma-order-item-table">
    <thead>
      <tr>
        <th></th>
        <th><?php esc_html_e( 'Tên sản phẩm', 'dokan' ); ?></th>
        <th><?php esc_html_e( 'Giá', 'dokan' ); ?></th>
        <th><?php esc_html_e( 'Người bán', 'dokan' ); ?></th>
        <th><?php esc_html_e( 'Số lượng', 'dokan' ); ?></th>
        <th><?php esc_html_e( 'Chi tiết bảo hành', 'dokan' ); ?></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><a
            href="<?php echo esc_url( $_product->get_permalink() ); ?>"><?php echo esc_html( $_product->get_title() ); ?></a>
        </td>
  ...
  <div class="warranty-form-row">
    <label for=""><?php esc_html_e( 'Tôi muốn yêu cầu', 'dokan' ); ?></label>
  ...
  <div class="warranty-form-row">
    <label for=""><?php esc_html_e( 'Chọn lý do để yêu cầu', 'dokan' ); ?></label>
  ...
  <div class="warranty-form-row">
    <label for=""><?php esc_html_e( 'Cho biết chi tiết về vấn đề của bạn ', 'dokan' ); ?></label>
  ...
  <div class="warranty-form-row">
    ...
    <input type="submit" name="warranty_submit_request" class="dokan-btn dokan-btn-theme"
      value="<?php esc_attr_e( 'Gửi yêu cầu', 'dokan' ); ?>">
  </div>
  ...
  <div class="warranty-no-product-row">
    <p><?php esc_html_e( 'Sản phẩm không tồn tại!', 'dokan' ); ?></p>
  </div>
  <?php endif ?>
