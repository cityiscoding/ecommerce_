...
class Dokan_Rma_Send_Warranty_Request extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'PallMall gửi yêu cầu hoàn tiền cho nhà cung cấp', 'dokan' );
    ...
    public function get_default_subject() {
        return __( '[{site_name}] Một yêu cầu hoàn lại và yêu cầu hoàn trả mới được gửi bởi ({customer_name})', 'dokan' );
    }
    ...
    public function get_default_heading() {
        return __( 'Hoàn lại tiền và yêu cầu trả lại được gửi bởi ({customer_name})', 'dokan' );
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'description'   => sprintf( __( 'Mô tả: %s', 'dokan' ), '<code>{blogname}</code>' ),
            ...
            'heading' => array(
                ...
                'desc_tip'      => true,
                /* translators: %s: list of placeholders */
                'description'   => sprintf( __( 'Mô tả: %s', 'dokan' ), '<code>{customer_name}</code>' ),
