...
<div id="dokan-mangopay-payment">
  ...
  <div id="dokan-mangopay-account"
    class="dokan-mangopay-container dokan-mangopay-account <?php echo $is_seller_connected ? 'tab-shown' : ''; ?>">
    ...
    <button class="button dokan-mp-btn-submit" id="dokan-mangopay-account-connect"
      data-user="<?php echo esc_attr( $user_id ); ?>">
      <?php esc_html_e( 'Connect', 'dokan' ); ?>
    </button>
    <button class="button" id="dokan-mangopay-account-processing" style="display: none;" disabled="disabled"
      data-user="<?php echo esc_attr( $user_id ); ?>">
      <?php esc_html_e( 'Processing', 'dokan' ); ?>...
    </button>
    <?php else : ?>
    <button class="button" id="dokan-mangopay-account-disconnect" data-user="<?php echo esc_attr( $user_id ); ?>">
