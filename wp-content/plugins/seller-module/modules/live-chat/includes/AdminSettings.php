    ...
    public function dokan_live_chat_settings( $settings ) {
        $settings['dokan_live_chat'] = [
            ...
            'app_secret'               => [
                ...
                'desc'        => sprintf( '%1$s <a target="_blank" href="%2$s">%3$s</a>', __( 'Insert App Secret', 'dokan' ), esc_url( 'https://talkjs.com/dashboard/signup/standard/' ), __( '(Truy cập Website để lấy App Secret)', 'dokan' ) ),
                'type'        => 'text',
                'secret_text' => true,
                'show_if' => [
                    'provider' => [
