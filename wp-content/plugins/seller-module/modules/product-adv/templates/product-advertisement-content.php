...
<div class="dokan-edit-row dokan-proudct-advertisement dokan-clearfix">
    ...
    <h2>
      <span class="fa-stack fa-xs tips">
        <i class="fa fa-circle fa-stack-2x"
          style="color: <?php echo esc_html( $advertise_active_color ); ?>; font-size: 2em;"></i>
  ...
  <div class="dokan-section-content">
    ...
    <label for="dokan_advertise_single_product">
      <input type="checkbox" id="dokan_advertise_single_product" name="dokan_advertise_single_product" value="on"
        ...
        <?php elseif ( $can_advertise_for_free ) : // ! empty( $remaining_slot ) will filter out 0(zero) and false value ?>
            <label for=" dokan_advertise_single_product">
      <input type="checkbox" id="dokan_advertise_single_product" name="dokan_advertise_single_product" value="off"
    ...
    <label for="dokan_advertise_single_product">
      ...
      <?php
                printf(
                    ...
                    __( 'Quảng cáo sản phẩm này với giá: <strong>%1$s</strong>, Chi phí quảng cáo: <strong>%2$s</strong>, Số lượt còn lại: <strong>%3$s</strong>', 'dokan' ),
