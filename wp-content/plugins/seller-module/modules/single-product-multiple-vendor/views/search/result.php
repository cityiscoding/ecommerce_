  ...
  <div class="dokan-dashboard-content dokan-orders-content">
    ...
    <article class="dokan-spmv-products-search-result-area">
      <?php
            ...
            ?>
      <table class="dokan-table dokan-table-striped product-listing-table" id="dokan-spmv-product-list-table"
        data-security="<?php echo esc_attr( wp_create_nonce( 'dokan_spmv_product_clone_from_search' ) ); ?>">
        <thead>
          <tr>
            <th><?php esc_html_e( 'Tên cửa hàng', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Giá', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Người bán', 'dokan' ); ?></th>
            <th><?php esc_html_e( 'Hành động', 'dokan' ); ?></th>
          </tr>
        </thead>
        <tbody>
          <?php
