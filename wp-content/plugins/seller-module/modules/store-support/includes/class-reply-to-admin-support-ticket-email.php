...
if ( ! class_exists( 'DokanReplyToAdminSupportTicket' ) ) :
    ...
    class DokanReplyToAdminSupportTicket extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title          = __( 'PallMall Trả lời ticked quản trị từ Nhà cung cấp & Khách hàng', 'dokan' );
            $this->description    = __( 'Một email được gửi đến quản trị viên khi nhà cung cấp hoặc khách hàng trả lời trên vé tùy thuộc vào cài đặt.', 'dokan' );
        ...
        public function get_default_subject() {
            return __( '[{site_title}] Một câu trả lời mới trên vé #{ticket_id}', 'dokan' );
        }
        ...
        public function get_default_heading() {
            return __( 'Một câu trả lời mới trên vé #{ticket_id}', 'dokan' );
        }
        ...
        public function trigger( $store_id, $email_data ) {
            ...
            if ( ! $this->is_enabled() || 'off' === $topic_specific_settings ) {
                return;
            }
