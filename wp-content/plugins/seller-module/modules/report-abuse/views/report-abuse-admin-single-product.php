    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <?php else: ?>
          <?php echo esc_html( $report['reported_by']['name'] ); ?>
          &lt;<?php echo esc_html( $report['reported_by']['email'] ); ?>&gt;
          <?php endif; ?>
        </td>
        <td>
          <?php
        ...
        <td>
          <button type="button" class="button button-small dokan-report-abuse-admin-single-product-delete-item"
            data-id="<?php echo esc_attr( $report['id'] ); ?>">
            <i class="far fa-trash-alt"></i> <?php esc_html_e( 'Xóa', 'dokan' ); ?>
          </button>
        </td>
      </tr>
      <?php endforeach; ?>
