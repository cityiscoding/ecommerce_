...
class AdminSingleProduct {
    ...
    public static function add_abuse_report_meta_box() {
        add_meta_box( 'dokan_report_abuse_reports', __( 'Báo cáo lạm dụng', 'dokan' ), [ self::class, 'meta_box' ], 'product', 'normal', 'core' );
    }
    ...
    public static function meta_box( $post ) {
        ...
        wp_localize_script( 'dokan-report-abuse-admin-single-product', 'dokanReportAbuse', [
            ...
            'i18n' => [
                'delete'              => esc_html__( 'Xóa', 'dokan' ),
                'deleting'            => esc_html__( 'Đang xóa', 'dokan' ),
