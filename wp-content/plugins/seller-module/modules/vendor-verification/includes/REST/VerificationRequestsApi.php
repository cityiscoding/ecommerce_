    ...
    public function get_item_schema(): array {
        $schema = [
            ...
            'properties' => [
                ...
                'vendor_id'       => [
                    'description' => __( 'ID nhà cung cấp liên quan đến yêu cầu xác minh.', 'dokan' ),
                    'type'        => 'integer',
                    'context'     => [ 'view', 'edit' ],
                    'readonly'    => false,
                    'required'    => true,
                ...
                'method_id'       => [
                    'description' => __( 'ID phương thức xác minh được liên kết với yêu cầu xác minh.', 'dokan' ),
                    'type'        => 'integer',
                    'context'     => [ 'view', 'edit' ],
                    'readonly'    => false,
                    'required'    => true,
                ...
                'status'          => [
                    'description' => __( 'Trạng thái yêu cầu xác minh.', 'dokan' ),
                    'type'        => 'string',
                    'context'     => [ 'view', 'edit' ],
                    'readonly'    => false,
                    'required'    => false,
                ...
                'status_title'    => [
                    'description' => __( 'Tiêu đề trạng thái yêu cầu xác minh.', 'dokan' ),
                    'type'        => 'string',
                    'context'     => [ 'view', 'edit' ],
                    'readonly'    => true,
                    'required'    => false,
                ...
                'note'            => [
                    'description' => __( 'Yêu cầu xác minh lưu ý cho quản trị viên.', 'dokan' ),
                    'type'        => 'string',
                    'context'     => [ 'view', 'edit' ],
                    'readonly'    => false,
                    'required'    => false,
