...
<div class="dokan-verification-content">
  ...
  <div class='dokan-panel dokan-panel-default'>
    <div class='dokan-panel-heading'>
      <strong><?php echo esc_html( $verification_method->get_title() ); ?></strong>
    ...
    <div class='dokan-panel-body'>
      ...
      <button class="dokan-btn dokan-btn-theme dokan-v-start-btn dokan-vendor-verification-start"
        ...
        data-method="<?php echo esc_attr( $verification_method->get_id() ); ?>"><?php esc_html_e( 'Start Verification', 'dokan' ); ?></button>
      <?php else : ?>
      <div class="dokan-verification-request-content">
        ...
        <div class='dokan-vendor-verification-file-container'
          ...
          <address><?php echo wp_kses_post( dokan_get_seller_address( $current_user ) ); ?></address>
          <?php endif; ?>
          <?php if ( ! empty( $last_verification_request->get_note() ) ) : ?>
          <p class="dokan-vendor-verification-file-heading">
            <?php esc_html_e( 'Thông báo xét duyệt của quản trị viên:', 'dokan' ); ?></p>
        ...
        <button class='dokan-btn dokan-btn-theme dokan-v-cancel-btn dokan-vendor-verification-cancel-request'
          ...
          data-nonce="<?php echo esc_attr( wp_create_nonce( 'dokan-vendor-verification-cancel-request' ) ); ?>"><?php esc_html_e( 'Cancel', 'dokan' ); ?></button>
        <?php else : ?>
        <button class='dokan-btn dokan-btn-theme dokan-v-start-btn dokan-vendor-verification-start'
          id="dokan-vendor-verification-start-<?php echo esc_attr( $verification_method->get_id() ); ?>"
          data-method="<?php echo esc_attr( $verification_method->get_id() ); ?>"><?php esc_html_e( 'Resubmit', 'dokan' ); ?></button>
        <?php endif; ?>
        <?php endif; ?>
      </div>
      ...
      <div class="dokan_v_verification_method_box dokan-hide"
        ...
        <?php echo wp_kses_post( wpautop( $verification_method->get_help_text() ) ); ?>
        <?php if ( $verification_method->get_kind() === VerificationMethod::TYPE_ADDRESS ) : ?>
        <p class="dokan-vendor-verification-file-heading"><?php esc_html_e( 'Address:', 'dokan' ); ?></p>
        <address><?php echo wp_kses_post( dokan_get_seller_address( $current_user ) ); ?></address>
        <?php endif; ?>

        <form method="post" id="dokan-verification-form-<?php echo esc_attr( $verification_method->get_id() ); ?>"
          ...
          <div class="dokan-form-group dokan-text-left">
            ...
            <div class="dokan-text-left">
              <div class="dokan-form-control">
                <div class="dokan-vendor-verification-method-files"
                  ...
                  <div class="dokan-vendor-verification-file-item" id="<?php echo $custom_id; ?>">
                    ...
                    <a href="#" onclick="dokanVendorVerificationRemoveFile(event)"
                      ...
                      <i class="fas fa-times" data-attachment_id="<?php echo $custom_id; ?>">
                      </i>
                    </a>
      ...
      <div class="dokan_v_phone_box">
        <form method="post" id="dokan-verify-phone-form" action="" class="dokan-form-horizontal">
          ...
          <div class="dokan-form-group">
            ...
            <div class="dokan-w5">
              <input id="phone" value="<?php echo $phone; ?>" name="phone" placeholder="+123456.."
                class="dokan-form-control input-md" type="text"><br>
              <?php if ( 'nexmo' === $active_gateway ) { ?>
              <div class="dokan-alert dokan-alert-warning">
                <?php _e( 'When entering US phone numbers, exclude the plus sign from the phone number.', 'dokan' ); ?>
              </div>
              <?php } ?>
              <?php do_action( 'dokan_before_phone_verification_submit_button', $seller_profile ); ?>
              <div class="dokan-form-group">
                <input type="submit" id='dokan_v_phone_submit' class="dokan-left dokan-btn dokan-btn-theme"
                  value="<?php esc_attr_e( 'Submit', 'dokan' ); ?>">
              </div>
            </div>
          </div>
        ...
        <form method="post" id="dokan-v-phone-code-form" action="" class="dokan-form-horizontal">
          ...
          <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label"
              for="sms_code"><?php esc_attr_e( 'SMS code', 'dokan' ); ?></label>
            <div class="dokan-w5">
              <input id="sms_code" value="" name="sms_code" placeholder="" class="dokan-form-control input-md"
                type="text">
            </div>
          </div>

          <div class="dokan-form-group">
            <input type="submit" id='dokan_v_code_submit' class="dokan-left dokan-btn dokan-btn-theme"
              value="<?php esc_attr_e( 'Submit', 'dokan' ); ?>">
          </div>
        </form>
      </div>
  ...
  <div class="dokan-panel dokan-panel-default">
    ...
    <div class="dokan-panel-body">
      <div class="dokan-verify-links">
        ...
        <a
          href="<?php echo add_query_arg( array( 'dokan_auth' => $provider ), dokan_get_navigation_url( 'settings/verification' ) ); ?>">
        ...
        <div class="dokan-va-row">
          <div class="dokan-w12">
            <div class="">
              <h2><u><?php echo ucwords( $provider ); ?></u></h2>
            </div>
            <div class="">
              <div class="dokan-w4"><img src="<?php echo $provider_info['photoURL']; ?>" /></div>
              <div class="dokan-w5"><a target="_blank"
                  href="<?php echo $provider_info['profileURL']; ?>"><?php echo $provider_info['displayName']; ?></a>
              </div>
            ...
            <div class="dokan_verify_dc_button">
              <a
                href="<?php echo add_query_arg( array( 'dokan_auth_dc' => $provider ), dokan_get_navigation_url( 'settings/verification' ) ); ?>">
