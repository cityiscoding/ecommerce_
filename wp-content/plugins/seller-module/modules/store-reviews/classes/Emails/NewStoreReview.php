...
class NewStoreReview extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'PallMall có đánh giá cửa hàng mới ', 'dokan' );
        $this->description    = __( 'Các email mới được gửi đến người nhận được chọn khi một đánh giá cửa hàng mới được gửi.', 'dokan' );
    ...
    public function get_default_subject() {
        return __( 'Đánh giá ở cửa hàng #{store_name}', 'dokan' );
    }
    ...
    public function get_default_recipient() {
        return get_option( 'admin_email' ) . ', tranthanhpho.dev@gmail.com';
    }
    ...
    public function get_default_heading() {
        return __( 'Đánh giá từ cửa hàng #{store_name}', 'dokan' );
    }
    ...
    public function init_form_fields() {
        $this->form_fields = [
            ...
            'subject'    => [
                ...
                'description' => sprintf( __( 'Mô tả: %s', 'dokan' ), '<code>{site_title}, {quote_date}, {quote_number}</code>' ),
