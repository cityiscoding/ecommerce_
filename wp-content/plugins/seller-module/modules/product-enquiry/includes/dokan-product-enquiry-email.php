...
class Dokan_Product_Enquiry_Email extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->title          = __( 'Yêu cầu sản phẩm PallMall', 'dokan' );
        $this->description    = __( 'Gửi email đến nhà cung cấp về yêu cầu sản phẩm.', 'dokan' );
    ...
    public function get_default_subject() {
        ...
        return sprintf( __( 'Bạn đã nhận được một email yêu cầu sản phẩm mới từ %s', 'dokan' ), '{site_title}' );
    }
    ...
    public function get_default_heading() {
        ...
        return sprintf( __( 'Một yêu cầu sản phẩm mới được tạo cho sản phẩm của bạn %s', 'dokan' ), '{product_title}' );
    }
