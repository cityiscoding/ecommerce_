  ...
  <div class="dokan-product-attribute-item dokan-clearfix dokan-hide">
    ...
    <div class="content-half-part dokan-attribute-values">
      ...
      <div class="dokan-pre-defined-attribute-btn-group">
        <button
          class="dokan-btn dokan-btn-default plus dokan-select-all-attributes"><?php esc_html_e( 'Select all', 'dokan' ); ?></button>
        <button
          class="dokan-btn dokan-btn-default minus dokan-select-no-attributes"><?php esc_html_e( 'Select none', 'dokan' ); ?></button>
      </div>
