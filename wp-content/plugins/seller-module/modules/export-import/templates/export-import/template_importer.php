        ...
        <div class="tabs_container">
          <div class="import_div tab-pane active" id="import">
            ...
            <form method='post' enctype='multipart/form-data' action="">
              ...
              <p><input type='submit' name='import_xml' value='<?php _e( 'Import', 'dokan' ); ?>'
          ...
          <div class="export_div tab-pane" id="export">
            ...
            <p>
              <?php _e( 'Chose your type of product and click export button to export all data in XML form', 'dokan' ); ?>
            </p>

            <form action="" method="POST">
              <p><input type="radio" name="content" value="all" id="export_all" checked="checked"> <label
                  for="export_all"><?php _e( 'Tất cả', 'dokan' ); ?></label></p>
              <p><input type="radio" name="content" value="product" id="export_product"> <label
                  for="export_product"><?php _e( 'Sản phẩm', 'dokan' ); ?></label></p>
              <p><input type="radio" name="content" value="product_variation" id="export_variation_product"> <label
                  for="export_variation_product"><?php _e( 'Biến thể sản phẩm', 'dokan' ); ?></label></p>
              <p><input type="submit" name="export_xml" value="<?php esc_attr_e( 'XUất tệp tin', 'dokan' ); ?>"
                  class="btn btn-danger"></p>
            </form>
