...
<div id="dokan-withdraw-schedule-popup"
  data-izimodal-title="<i class='fa fa-clock-o' aria-hidden='true'></i>&nbsp;<?php esc_html_e( 'Chỉnh sửa lịch rút tiền', 'dokan' ); ?>">
</div>
...
<div class="dokan-clearfix dokan-panel-inner-container">
  <div class="dokan-w8">
    <div>
      <div class="dokan-switch-container">
        <strong><?php esc_html_e( 'Lịch trình', 'dokan' ); ?></strong>
        <label class='dokan-switch'>
          <input type='checkbox' <?php echo esc_attr( $is_schedule_selected ? 'checked' : '' ); ?>
  ...
  <div class="dokan-w5">
    <button class="dokan-btn"
      id="dokan-withdraw-display-schedule-popup"><?php esc_html_e( 'Chỉnh sửa lịch trình', 'dokan' ); ?></button>
