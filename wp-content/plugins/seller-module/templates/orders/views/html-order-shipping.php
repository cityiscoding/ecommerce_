...
<tr class="shipping <?php echo ( ! empty( $class ) ) ? $class : ''; ?>" data-order_item_id="<?php echo $item_id; ?>">
  ...
  <td class="name">
    ...
    <div class="edit" style="display: none;">
      <input style="width:60px" type="text" placeholder="<?php esc_attr_e( 'Shipping Name', 'dokan' ); ?>"
        name="shipping_method_title[<?php echo $item_id; ?>]"
      ...
      <select name="shipping_method[<?php echo $item_id; ?>]">
        <optgroup label="<?php esc_attr_e( 'Shipping Method', 'dokan' ); ?>">
          <option value=""><?php esc_html_e( 'Không có', 'dokan' ); ?></option>
          <?php
						$found_method = false;
  ...
  <td class="line_cost" width="1%">
    ...
    <div class="edit" style="display: none;">
      <input style="width:60px" type="text" name="shipping_cost[<?php echo $item_id; ?>]"
        placeholder="<?php echo wc_format_localized_price( 0 ); ?>"
        value="<?php echo ( isset( $item['cost'] ) ) ? esc_attr( wc_format_localized_price( $item['cost'] ) ) : ''; ?>"
    ...
    <div class="refund" style="display: none;">
      <input style="width:60px" type="text" name="refund_line_total[<?php echo absint( $item_id ); ?>]"
        placeholder="<?php echo wc_format_localized_price( 0 ); ?>" class="refund_line_total wc_input_price" />
    </div>
    <?php endif; ?>
  </td>
  ...
  <td class="line_tax" width="1%">
    ...
    <div class="refund" style="display: none;">
      <input style="width:60px" type="text"
        ...
        placeholder="<?php echo wc_format_localized_price( 0 ); ?>" class="refund_line_tax wc_input_price"
