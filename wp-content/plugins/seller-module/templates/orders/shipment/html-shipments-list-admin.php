<div
  class="shipping-status-tracking-shippments-inner shippments-inner-<?php echo esc_html( $incre ); ?> shipment_id_<?php echo esc_attr( $shipment_id ); ?>">
  ...
  <div
    class="dokan-customer-shipment-notes-list-area dokan-hide shipment_notes_area_<?php echo esc_attr( $shipment_id ); ?>">
    <h5><strong><?php esc_html_e( 'Thời gian cập nhật lô hàng', 'dokan' ); ?></strong></h5>
