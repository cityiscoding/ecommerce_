...
<div class="dashboard-widget dokan-announcement-widget">
  <div class="widget-title">
    <i class="fas fa-bullhorn" aria-hidden="true"></i> <?php esc_html_e( 'Thông báo mới nhất', 'dokan' ); ?>

    <span class="pull-right">
      <a href="<?php echo $announcement_url; ?>"><?php esc_html_e( 'Xem tất cả', 'dokan' ); ?></a>
    </span>
  </div>
  ...
  <div class="dokan-no-announcement">
    <div class="annoument-no-wrapper">
      ...
      <p><?php esc_html_e( 'Không tìm thấy thông báo', 'dokan' ); ?></p>
    </div>
  </div>
  <?php elseif ( $notices ) : ?>
  <ul class="list-unstyled">
    ...
    <li>
      ...
      <div
        class="dokan-dashboard-announce-date dokan-right <?php echo ( $notice->get_read_status() === 'unread' ) ? 'dokan-dashboard-announce-unread' : 'dokan-dashboard-announce-read'; ?>">
