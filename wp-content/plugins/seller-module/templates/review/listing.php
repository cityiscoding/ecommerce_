...
<table id="dokan-comments-table" class="dokan-table dokan-table-striped">
  <thead>
    <tr>
      ...
      <?php } ?>
      <th class="col-author"><?php esc_html_e( 'Tác giả', 'dokan' ); ?></th>
      <th class="col-content"><?php esc_html_e( 'Bình luận', 'dokan' ); ?></th>
      <th class="col-link"><?php esc_html_e( 'Liên kết đến', 'dokan' ); ?></th>
      <th class="col-link"><?php esc_html_e( 'Xếp hạng', 'dokan' ); ?></th>
    </tr>
  </thead>
