    ...
    <div class="dokan-form-group">
      ...
      <label class="dokan-on-off dokan-status" for="<?php echo esc_attr( $day_key ); ?>-working-status">
        ...
        <p class='working-status'>
          <input type="hidden" name="store_day[<?php echo esc_attr( $day_key ); ?>]"
            id="<?php echo esc_attr( $day_key ); ?>-working-status" class="dokan-on-off toogle-checkbox"
            value="<?php echo 'open' === $working_status ? '1' : '0'; ?>" />
          <span class="open-status"><?php esc_html_e( 'Mở', 'dokan' ); ?></span>
          <span class="close-status"><?php esc_html_e( 'Đóng', 'dokan' ); ?></span>
        </p>
      </label>
      ...
      <label for="opening-time-<?php echo esc_attr( $day_key ); ?>" class="time"
        ...
        <div class='clock-picker'>
          ...
          <input type="text" class="dokan-form-control opening-time"
            id="opening-time-<?php echo esc_attr( $day_key ); ?>" placeholder="<?php echo esc_attr( $place_start ); ?>"
      ...
      <span class="time-to fas fa-minus"
        style="visibility: <?php echo 'open' === $working_status ? 'visible' : 'hidden'; ?>; display: <?php echo $full_day ? 'none' : 'block'; ?>"></span>
      ...
      <label class="time" for="closing-time-<?php echo esc_attr( $day_key ); ?>"
        ...
        <div class='clock-picker'>
          ...
          <input type="text" class="dokan-form-control closing-time"
            id="closing-time-<?php echo esc_attr( $day_key ); ?>" placeholder="<?php echo esc_attr( $place_end ); ?>"
      ...
      <label for="open-close-actions" class="open-close-actions"
        ...
        <a href="" class="added-store-opening-time"
          style='display: <?php echo $full_day ? 'none' : 'block'; ?>'><?php echo esc_html( $add_action ); ?></a>
      </label>
