...
if ( $tracking_info ) {
	$ship_info = __( 'Nhà cung cấp vận chuyển: ', 'dokan' ) . $tracking_info->provider_label . '<br />' . __( 'Mã đơn hàng: ', 'dokan' ) . $tracking_info->number . '<br />' . __( 'Ngày dự kiến giao hàng: ', 'dokan' ) . $tracking_info->date . '<br />' . __( 'Trạng thái đơn hàng hiện tạ<i></i>: ', 'dokan' ) . $tracking_info->status_label;
