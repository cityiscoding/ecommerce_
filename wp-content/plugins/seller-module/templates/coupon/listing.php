...
<div class="dokan-report-wrap">
  <ul class="dokan_tabs">
    <li class="<?php echo ! $marketplace_tab ? 'active' : ''; ?>">
      <a
        href="<?php echo esc_url( add_query_arg( array( 'coupons_type' => 'vendor_coupons' ), $link ) ); ?>"><?php esc_html_e( 'Phiếu giảm giá của tôi', 'dokan' ); ?></a>
    </li>
    <li class="<?php echo $marketplace_tab ? 'active' : ''; ?>">
      <a
        href="<?php echo esc_url( add_query_arg( array( 'coupons_type' => 'marketplace_coupons' ), $link ) ); ?>"><?php esc_html_e( 'Phiếu giảm giá cửa hàng', 'dokan' ); ?></a>
    </li>
  </ul>
