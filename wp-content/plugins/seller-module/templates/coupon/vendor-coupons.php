<table class="dokan-table">
  <thead>
    <tr>
      <th><?php esc_html_e( 'Mã', 'dokan' ); ?></th>
      <th><?php esc_html_e( 'Loại phiếu giảm giá', 'dokan' ); ?></th>
      <th><?php esc_html_e( 'Số tiền phiếu giảm giá', 'dokan' ); ?></th>
      <th><?php esc_html_e( 'ID sản phẩm', 'dokan' ); ?></th>
      <th><?php esc_html_e( 'Sử dụng / giới hạn', 'dokan' ); ?></th>
      <th><?php esc_html_e( 'Ngày hết hạn', 'dokan' ); ?></th>
    </tr>
  </thead>
  ...
  <tr>
    <td class="coupon-code column-primary" data-title="<?php esc_attr_e( 'Code', 'dokan' ); ?>">
      ...
      <div class="code">
        ...
        <strong><a
            href="<?php echo esc_url( $edit_url ); ?>"><span><?php echo esc_attr( $coupon->get_code() ); ?></span></a></strong>
        <?php } else { ?>
      ...
      <div class="row-actions">
        ...
        <?php if ( current_user_can( 'dokan_edit_coupon' ) ) { ?>
        <span class="edit"><a
            href="<?php echo esc_url( $edit_url ); ?>"><?php esc_html_e( 'Chỉnh sửa', 'dokan' ); ?></a> |
        </span>
        <?php } ?>

        <?php if ( current_user_can( 'dokan_delete_coupon' ) ) { ?>
        <span class="delete"><a href="<?php echo esc_url( $del_url ); ?>"
            onclick="return confirm('<?php esc_attr_e( 'Bạn có chắc chắn muốn xóa', 'dokan' ); ?>');"><?php esc_html_e( 'Xóa bỏ', 'dokan' ); ?></a></span>
        <?php } ?>
      </div>
