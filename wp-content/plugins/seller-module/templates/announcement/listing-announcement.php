...
<div class="dokan-announcement-wrapper">
  ...
  <?php
    ...
    foreach ( $notices as $notice ) {
        ...
        ?>
  <div
    class="dokan-announcement-wrapper-item <?php echo ( $notice->get_read_status() === 'unread' ) ? 'dokan-announcement-uread' : ''; ?>">
    <div class="announcement-action">
      <a href="#" class="remove_announcement" data-notice_row=<?php echo $notice->get_notice_id(); ?>><i
