...
<article class="dokan-notice-single-notice-area">
  ...
  <span class="dokan-single-announcement-date"><i class="far fa-calendar-alt"></i>
    <?php echo dokan_format_date( $notice->get_date() ); ?></span>
  ...
  <div class="dokan-announcement-link">
    <a href="<?php echo esc_url( dokan_get_navigation_url( 'announcement' ) ); ?>"
      class="dokan-btn dokan-btn-theme"><?php esc_html_e( 'Quay lại tất cả', 'dokan' ); ?></a>
  </div>
</article>