...
<div class="dokan-discount-options dokan-edit-row dokan-clearfix hide_if_external">
  <div class="dokan-section-heading" data-togglehandler="dokan_discount_options">
    <h2><i class="fas fa-gift"></i> <?php esc_html_e( 'Tùy chọn giảm giá', 'dokan' ); ?></h2>
    <p><?php esc_html_e( 'Đặt giảm giá cho sản phẩm này', 'dokan' ); ?></p>
  ...
  <div class="dokan-section-content">
    <label class="dokan-form-label" for="<?php echo ProductDiscount::IS_LOT_DISCOUNT; ?>">
      <input type="checkbox" id="<?php echo ProductDiscount::IS_LOT_DISCOUNT; ?>"
        name="<?php echo ProductDiscount::IS_LOT_DISCOUNT; ?>" value="yes"
        <?php checked( $lot_discount_enabled, 'yes' ); ?> />
      <?php esc_html_e( 'Cho phép giảm giá hàng loạt', 'dokan' ); ?>
    </label>
    ...
    <div class="show_if_needs_lot_discount <?php echo ( $lot_discount_enabled === 'yes' ) ? '' : 'dokan-hide'; ?>">
      <div class="content-half-part">
        <label class="dokan-form-label" for="<?php echo ProductDiscount::LOT_DISCOUNT_QUANTITY; ?>">
          <?php esc_html_e( 'Số lượng tối thiểu', 'dokan' ); ?>
        </label>
        <input type="number" id="<?php echo ProductDiscount::LOT_DISCOUNT_QUANTITY; ?>"
          name="<?php echo ProductDiscount::LOT_DISCOUNT_QUANTITY; ?>" value="<?php echo $product_discount_quantity; ?>"
          placeholder="0" min="0" class="dokan-form-control" />
      </div>
      <div class="dokan-form-group content-half-part">
        ...
        <div class="dokan-input-group">
          <input type="text" id="<?php echo ProductDiscount::LOT_DISCOUNT_AMOUNT; ?>"
            name="<?php echo ProductDiscount::LOT_DISCOUNT_AMOUNT; ?>" value="<?php echo $product_discount_amount; ?>"
            placeholder="<?php esc_attr_e( 'Percentage', 'dokan' ); ?>" class="dokan-form-control" />
