      ...
      <fieldset>
        <div class="dokan-clearfix">
          <div class="dokan-w4 dokan-inline-edit-column">
            <strong
              class="dokan-inline-edit-section-title"><?php esc_html_e( 'Chỉnh sửa hàng loạt', 'dokan' ); ?></strong>
            <div id="bulk-product-list" class="cat-checklist product_cat-checklist dokan-category-checklist"></div>
          </div>
          <div class="dokan-w8">
            <strong
              class="dokan-inline-edit-section-title"><?php esc_html_e( 'Danh mục sản phẩm', 'dokan' ); ?></strong>
            <?php
          ...
          <div class="dokan-w8">
            <div>
              <label>
                <strong class="dokan-inline-edit-section-title"><?php esc_html_e( 'Trạng thái', 'dokan' ); ?></strong>
            ...
            <div class="dokan-w12 dokan-inline-edit-column">
              <label>
                <strong class="dokan-inline-edit-section-title"><?php esc_html_e( 'Thẻ sản phẩm', 'dokan' ); ?></strong>
              </label>
              <select multiple="multiple" data-field-name="product_tagz" name="product_tags[]"
                ...
                <option value="<?php echo esc_attr( $value->term_id ); ?>" selected='selected'>
        ...
        <br />
        <div class="dokan-clearfix">
          <strong class="dokan-inline-edit-section-title">
            <h4><?php esc_html_e( 'Dữ liệu sản phẩm', 'dokan' ); ?></h4>
          </strong>
          <div class="dokan-w6 dokan-inline-edit-column">
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              ...
              <div class="dokan-w9">
                ...
                <input type="text" name="_regular_price" id="dokan_bulk_regular_price"
                  class="dokan-mt10 dokan-form-control dokan-hide"
                  placeholder="<?php printf( esc_attr__( 'Giá (%s)', 'dokan' ), get_woocommerce_currency_symbol() ); ?>"
                  value="" />
              </div>
            </div>
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              ...
              <div class="dokan-w9">
                ...
                <?php /* translators: %s is woocommerce currency symbol. */ ?>
                <input type="text" name="_sale_price" id="dokan_bulk_sale_price"
                  class="dokan-mt10 dokan-form-control dokan-hide"
                  placeholder="<?php printf( esc_attr__( 'Enter sale price (%s)', 'dokan' ), get_woocommerce_currency_symbol() ); ?>"
                  value="" />
              </div>
            </div>
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              <label class="dokan-w3">
                <?php esc_html_e( 'Tình trạng thuế', 'dokan' ); ?>
              </label>
              <div class="dokan-w9">
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              ...
              <div class="dokan-w9">
                ...
                <input class="dokan-mt10 dokan-form-control dokan-hide" id="_weight" type="text" name="_weight"
                  placeholder="<?php printf( esc_attr__( '%1$s (%2$s)', 'dokan' ), wc_format_localized_decimal( 0 ), get_option( 'woocommerce_weight_unit' ) ); ?>"
                  value="">
              </div>
            </div>
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              ...
              <div class="dokan-w9">
                ...
                <input type="text" id="_length" name="_length"
                  class="dokan-mt10 dokan-form-control dokan-hide text length"
                  placeholder="<?php echo sprintf( esc_attr__( 'Length (%s)', 'dokan' ), get_option( 'woocommerce_dimension_unit' ) ); ?>"
                  value="">
                <?php /* translators: %s is woocommerce dimension unit */ ?>
                <input type="text" id="_width" name="_width" class="dokan-mt10 dokan-form-control dokan-hide text width"
                  placeholder="<?php echo sprintf( esc_attr__( 'Width (%s)', 'dokan' ), get_option( 'woocommerce_dimension_unit' ) ); ?>"
                  value="">
                <?php /* translators: %s is woocommerce dimension unit */ ?>
                <input type="text" id="_height" name="_height"
                  class="dokan-mt10 dokan-form-control dokan-hide text height"
                  placeholder="<?php echo sprintf( esc_attr__( 'Height (%s)', 'dokan' ), get_option( 'woocommerce_dimension_unit' ), true ); ?>"
                  value="">
              </div>
            </div>
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              ...
              <div class="dokan-w9">
                <select class="dokan-form-control" name="_shipping_class">
                  <option value=""><?php esc_html_e( '- Không thay đổi -', 'dokan' ); ?></option>
                  ...
                  <option value="<?php echo esc_attr( $value->slug ); ?>"><?php echo esc_html( $value->name ); ?>
                  </option>
                  <?php endforeach; ?>
                </select>
              </div>
          ...
          <div class="dokan-w6 dokan-inline-edit-column">
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              <label class="dokan-w3">
                <?php esc_html_e( 'Quản lý kho?', 'dokan' ); ?>
              </label>
              <div class="dokan-w9">
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              ...
              <div class="dokan-w9">
                ...
                <input type="text" name="_stock" id="_stock" class="dokan-mt10 dokan-form-control dokan-hide text stock"
                  placeholder="<?php esc_attr_e( 'Stock qty', 'dokan' ); ?> " step="any" value="">
              </div>
            </div>
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              <label class="dokan-w3">
                <?php esc_html_e( 'Đặt hàng trước?', 'dokan' ); ?>
              </label>
              <div class="dokan-w9">
            ...
            <div class="dokan-inline-edit-field-row dokan-clearfix">
              <label class="dokan-w3">
                <?php esc_html_e( 'Bán riêng lẻ?', 'dokan' ); ?>
              </label>
              <div class="dokan-w9">
        ...
        <div class="dokan-clearfix quick-edit-submit-wrap">
          ...
          <div class="dokan-right inline-edit-submit-button">
            ...
            <button id="bulk_edit_update_btn" type="submit"
              class="dokan-btn dokan-btn-default dokan-btn-theme dokan-right">
