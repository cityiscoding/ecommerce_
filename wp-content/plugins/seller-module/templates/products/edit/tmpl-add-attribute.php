...
<li class="product-attribute-list">
  ...
  <div class="dokan-product-attribute-item dokan-clearfix dokan-hide">
    ...
    <div class="content-half-part">
      ...
      <select name="" id="" multiple style="width:100%" class="dokan-select2" data-placeholder="Select name"
        data-tags="true" data-allow-clear="true" data-token-separators="[',', '|']"></select>
    </div>
  </div>
</li>
</script>