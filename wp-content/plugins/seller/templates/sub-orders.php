...
<header>
  <h2><?php esc_html_e( 'Đơn hàng kèm theo', 'dokan-lite' ); ?></h2>
</header>

<div class="dokan-info">
  <strong><?php esc_html_e( 'Ghi chú:', 'dokan-lite' ); ?></strong>
  <?php
    /**
...
<table class="shop_table my_account_orders table table-striped">
  <thead>
    <tr>
      ...
      <th class="order-shipment-status"><?php esc_html_e( 'Giao hàng', 'dokan-lite' ); ?></th>
      <?php endif; ?>
  ...
  <tbody>
    ...
    <tr class="order">
      <td class="order-number">
        <a
          href="<?php echo esc_url( is_callable( [ $order, 'get_view_order_url' ] ) ? $order->get_view_order_url() : '#' ); ?>">
