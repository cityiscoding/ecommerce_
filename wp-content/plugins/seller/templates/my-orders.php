...
<h2>
  <?php echo esc_html( apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'dokan-lite' ) ) ); ?>
</h2>

<table class="shop_table my_account_orders table table-striped">
  <thead>
    <tr>
      <th class="order-number"><span class="nobr"><?php esc_html_e( 'Đơn hàng', 'dokan-lite' ); ?></span></th>
      <th class="order-date"><span class="nobr"><?php esc_html_e( 'Ngày', 'dokan-lite' ); ?></span></th>
      <th class="order-status"><span class="nobr"><?php esc_html_e( 'Trạng thái', 'dokan-lite' ); ?></span></th>
      <th class="order-total"><span class="nobr"><?php esc_html_e( 'Tổng', 'dokan-lite' ); ?></span></th>
      <th class="order-total"><span class="nobr"><?php esc_html_e( 'Người bán', 'dokan-lite' ); ?></span></th>
      ...
      <td class="order-total">
        <?php
                    ...
                    if ( $seller_id !== 0 ) {
                        ...
                        esc_html_e( 'Nhiều nhà cung cấp', 'dokan-lite' );
                    }
                    ?>
      </td>
...
<p class="dokan-info"><?php esc_html_e( 'Không tìm thấy đơn hàng nào!', 'dokan-lite' ); ?></p>
