<h1><?php esc_html_e( 'Thiết lập cửa hàng', 'dokan-lite' ); ?></h1>
<form method="post">
  <table class="form-table">
    ...
    <tr>
      <th scope="row"><label
          for="custom_store_url"><?php esc_html_e( 'URL cửa hàng của kênh người bán', 'dokan-lite' ); ?></label>
      </th>
      <td>
        <input type="text" id="custom_store_url" name="custom_store_url" class="location-input"
          value="<?php echo esc_attr( $custom_store_url ); ?>" />
        <p class="description"><?php esc_html_e( 'Xác định URL cửa hàng của kênh người bán', 'dokan-lite' ); ?>
          (<?php echo esc_url( site_url() ); ?>/[this-text]/[seller-name])</p>
      </td>
    </tr>
    <tr>
      <th scope="row"><label
          for="shipping_fee_recipient"><?php esc_html_e( 'Người nhận phí vận chuyển', 'dokan-lite' ); ?></label></th>
      <td>
        ...
        <p class="description"><?php esc_html_e( 'Phí vận chuyển sẽ chuyển đến', 'dokan-lite' ); ?></p>
      </td>
    </tr>
    <tr>
      <th scope="row"><label
          for="tax_fee_recipient"><?php esc_html_e( 'Người nhận phí thuế sản phẩm', 'dokan-lite' ); ?></label></th>
      <td>
        ...
        <p class="description"><?php esc_html_e( 'Phí thuế sản phẩm sẽ được chuyển đến', 'dokan-lite' ); ?></p>
      </td>
    </tr>
    <tr>
      <th scope='row'><label
          for='tax_fee_recipient'><?php esc_html_e( 'Người nhận phí thuế vận chuyển', 'dokan-lite' ); ?></label>
      </th>
      <td>
        ...
        <p class="description"><?php esc_html_e( 'Phí vận chuyển Thuế sẽ chuyển đến', 'dokan-lite' ); ?></p>
      </td>
    </tr>
    <tr>
      <th scope="row"><label for="map_api_source"><?php esc_html_e( 'API bản đồ', 'dokan-lite' ); ?></label></th>
      <td>
        ...
        <p class="description">
          <?php esc_html_e( 'API bản đồ nào bạn muốn sử dụng trong trang web của mình?', 'dokan-lite' ); ?></p>
      </td>
    </tr>
    <tr id="google_maps_api_wrapper">
      <th scope="row"><label for="gmap_api_key"><?php esc_html_e( 'Google Map API Key', 'dokan-lite' ); ?></label></th>
      <td>
        <input type="text" id="gmap_api_key" name="gmap_api_key" class="location-input"
          value="<?php echo esc_attr( $gmap_api_key ); ?>" />
        <p class="description">
          <?php
                    printf(
    ...
    <tr id="mapbox_api_wrapper">
      <th scope="row"><label
          for="mapbox_access_token"><?php esc_html_e( 'Mapbox Access Token', 'dokan-lite' ); ?></label></th>
      <td>
        <input type="text" id="mapbox_access_token" name="mapbox_access_token" class="location-input"
          value="<?php echo esc_attr( $mapbox_access_token ); ?>" />
        <p class="description">
          <?php
                    echo sprintf(
                        /* translators: %1$s: opening anchor tag, %2$s: closing anchor tag */
    ...
    <tr>
      <th scope="row"><label
          for="share_essentials"><?php esc_html_e( 'Chia sẻ những thông tin', 'dokan-lite' ); ?></label>
      </th>
          ...
          <?php
                    echo wp_kses(
                        sprintf(
                            ...
                            __( 'Bạn muốn giúp PallMall-Seller trở nên tuyệt vời hơn nữa? Cho phép PallMall-Seller thu thập dữ liệu chẩn đoán không nhạy cảm và thông tin sử dụng. %1$sNhững gì chúng tôi thu thập%2$s', 'dokan-lite' ),
