...
<div
  class="dokan-alert <?php echo ( 'success' === $connect_status ) ? 'dokan-alert-success' : 'dokan-alert-danger'; ?>">
  <?php echo wp_kses_post( $status_message ); ?>
</div>
<?php endif; ?>

<a href="<?php echo esc_url_raw( dokan_get_navigation_url( 'settings/payment' ) ); ?>">
  &larr; <?php esc_html_e( 'Trở lại', 'dokan-lite' ); ?>
</a>
...
<form method="post" id="payment-form" action="" class="dokan-form-horizontal">
  ...
  <fieldset class="payment-field-<?php echo esc_attr( $method_key ); ?>">
    <div class="dokan-form-group">
      ...
      <label class="dokan-w3 dokan-control-label"
        for="dokan_setting"><?php echo esc_html( apply_filters( 'dokan_payment_method_title', $method['title'], $method ) ); ?></label>
      <div class="dokan-w6">
  ...
  <div class="dokan-form-group">
    <div class="dokan-w4 ajax_prev save dokan-text-left">
      <input type="submit" name="dokan_update_payment_settings" class="dokan-btn dokan-btn-danger dokan-btn-theme"
