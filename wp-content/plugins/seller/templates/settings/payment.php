...
<div class="dokan-payment-settings-summary">
  ...
  <div class="payment-methods-listing-header">
    <h2> <?php esc_html_e( 'Phương thức thanh toán', 'dokan-lite' ); ?></h2>
    <div>
      <div id="vendor-dashboard-payment-settings-toggle-dropdown">
        <a id="toggle-vendor-payment-method-drop-down">
          <?php esc_html_e( 'Thêm phương thức thanh toán', 'dokan-lite' ); ?></a>
        <div id="vendor-payment-method-drop-down-wrapper">
          <div id="vendor-payment-method-drop-down">
            ...
            <ul>
              ...
              <li>
                <a
                  href="<?php echo esc_url( dokan_get_navigation_url( 'settings/payment-manage-' . $method_key ) ); ?>">
                  <div>
            ...
            <div class="no-content">
              <?php esc_html_e( 'Không có phương thức thanh toán nào để thêm.', 'dokan-lite' ); ?>
            </div>
            <?php endif; ?>
          </div>
        </div>
  ...
  <ul>
    ...
    <li>
      <div>
        ...
        <div>
          <a
            href="<?php echo esc_url( dokan_get_navigation_url( 'settings/payment-manage-' . $method_key . '-edit' ) ); ?>">
            <button class="dokan-btn-theme dokan-btn-sm"><?php esc_html_e( 'Quản lý', 'dokan-lite' ); ?></button>
          </a>
        </div>
      </div>
    </li>
  ...
  <?php else : ?>
  <div class="no-content">
    <?php esc_html_e( 'Không có phương thức thanh toán nào để hiển thị.', 'dokan-lite' ); ?>
  </div>
  <?php endif; ?>
</div>
