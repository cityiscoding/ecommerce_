...
$store_status = [
    'close' => __( 'Đóng', 'dokan-lite' ),
    'open'  => __( 'Mở', 'dokan-lite' ),
];
...
<form method="post" id="store-form" action="" class="dokan-form-horizontal">
  ...
  <div class="dokan-banner">
    ...
    <div class="button-area<?php echo $banner_id ? ' dokan-hide' : ''; ?>">
      ...
      <a href="#"
        class="dokan-banner-drag dokan-btn dokan-btn-info dokan-theme dokan-btn-theme"><?php esc_html_e( 'Tải ảnh banner', 'dokan-lite' ); ?></a>
      <p class="help-block">
        <?php
                /**
  ...
  <div class="dokan-form-group">
    <label class="dokan-w3 dokan-control-label"
      for="dokan_gravatar"><?php esc_html_e( 'Ảnh đại diện', 'dokan-lite' ); ?></label>
    ...
    <div class="dokan-w5 dokan-gravatar">
      ...
      <div class="gravatar-button-area<?php echo esc_attr( $gravatar_id ) ? ' dokan-hide' : ''; ?>">
        <a href="#" class="dokan-pro-gravatar-drag dokan-btn dokan-btn-default"><i class="fas fa-cloud-upload-alt"></i>
          <?php esc_html_e( 'Tải ảnh lên', 'dokan-lite' ); ?></a>
      </div>
    </div>
  </div>
  ...
  <div class="dokan-form-group">
    <label class="dokan-w3 dokan-control-label"
      for="dokan_store_name"><?php esc_html_e( 'Tên cửa hàng', 'dokan-lite' ); ?></label>

    <div class="dokan-w5 dokan-text-left">
      <input id="dokan_store_name" required value="<?php echo esc_attr( $storename ); ?>" name="dokan_store_name"
        placeholder="<?php esc_attr_e( 'store name', 'dokan-lite' ); ?>" class="dokan-form-control" type="text">
    </div>
  </div>
  ...
  <div class="dokan-form-group">
    <label class="dokan-w3 dokan-control-label"
      for="setting_phone"><?php esc_html_e( 'Số điện thoại', 'dokan-lite' ); ?></label>
    <div class="dokan-w5 dokan-text-left">
      <input id="setting_phone" value="<?php echo esc_attr( $phone ); ?>" name="setting_phone"
        placeholder="<?php esc_attr_e( 'Ví dụ: Số điện thoại 0857332962 -> +84857332962', 'dokan-lite' ); ?>"
    ...
    <div class="dokan-w5 dokan-text-left">
      <div class="checkbox">
        <label>
          ...
          <input type="checkbox" name="setting_show_email" value="yes" <?php checked( $show_email, 'yes' ); ?>>
          <?php esc_html_e( 'Hiển thị địa chỉ email trong cửa hàng', 'dokan-lite' ); ?>
        </label>
      </div>
    </div>
  </div>
  ...
  <div class="dokan-form-group">
    <label
      class="dokan-w3 dokan-control-label"><?php esc_html_e( 'Các điều khoản và điều kiện', 'dokan-lite' ); ?></label>
    <div class="dokan-w5 dokan-text-left dokan_tock_check">
      <div class="checkbox">
        <label>
          <input type="checkbox" id="dokan_store_tnc_enable" value="on"
            <?php echo $enable_tnc === 'on' ? 'checked' : ''; ?> name="dokan_store_tnc_enable">
          <?php esc_html_e( 'Hiển thị các điều khoản và điều kiện trong trang cửa hàng', 'dokan-lite' ); ?>
        </label>
      </div>
    </div>
  </div>
  <div class="dokan-form-group" id="dokan_tnc_text">
    <label class="dokan-w3 dokan-control-label"
      for="dokan_store_tnc"><?php esc_html_e( 'Chi tiết Điều khoản và Điều kiện', 'dokan-lite' ); ?></label>
  ...
  <div class="dokan-form-group store-open-close-time">
    <label class="dokan-w3 dokan-control-label" for="dokan-store-close">
      <?php esc_html_e( 'Lịch trình cửa hàng', 'dokan-lite' ); ?>
    </label>
    ...
    <div class="dokan-w5 dokan-text-left dokan_tock_check">
      <div class="checkbox">
        <label for="dokan-store-time-enable" class="control-label">
          ...
          <?php esc_html_e( 'Cửa hàng có thời gian đóng cửa mở cửa', 'dokan-lite' ); ?>
        </label>
      </div>
    </div>
  </div>
  ...
  <div class="dokan-form-group store-open-close">
    <label class="dokan-w3 dokan-control-label" for="dokan-store-time-notice">
      <?php esc_html_e( 'Thông báo mở cửa hàng', 'dokan-lite' ); ?>
    </label>
    <div class="dokan-w6">
  ...
  <div class="dokan-form-group store-open-close">
    <label class="dokan-w3 dokan-control-label" for="dokan-store-time-notice">
      <?php esc_html_e( 'Thông báo đóng cửa hàng', 'dokan-lite' ); ?>
    </label>
    <div class="dokan-w6">
