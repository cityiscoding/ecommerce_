...
<div class="dokan-form-group">
  <label class="<?php echo esc_attr( $label_class ); ?> dokan-control-label"
    for="setting_address"><?php esc_html_e( 'Địa chỉ', 'dokan-lite' ); ?></label>

  <div class="<?php echo esc_attr( $field_class ); ?> dokan-text-left dokan-address-fields">
    <?php if ( $seller_address_fields['street_1'] ) { ?>
    <div class="dokan-form-group">
      <label class="control-label"
        for="dokan_address[street_1]"><?php esc_html_e( 'Địa chỉ chính của cửa hàng ', 'dokan-lite' ); ?>
        <?php
                    $required_attr = '';
      ...
      <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ); ?> id="dokan_address[street_1]"
        value="<?php echo esc_attr( $address_street1 ); ?>" name="dokan_address[street_1]"
        placeholder="<?php esc_attr_e( 'Street address', 'dokan-lite' ); ?>" class="dokan-form-control input-md"
        type="text">
    </div>
    <?php
        }
    ...
    <div class="dokan-form-group">
      <label class="control-label"
        for="dokan_address[street_2]"><?php esc_html_e( 'Địa chỉ thứ 2 của cửa hàng', 'dokan-lite' ); ?>
        <?php
                    $required_attr = '';
      ...
      <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ); ?> id="dokan_address[street_2]"
        value="<?php echo esc_attr( $address_street2 ); ?>" name="dokan_address[street_2]"
    ...
    <div class="dokan-from-group">
      ...
      <div class="dokan-form-group dokan-w6 dokan-left dokan-right-margin-30">
        <label class="control-label" for="dokan_address[city]"><?php esc_html_e( 'Thành Phố', 'dokan-lite' ); ?>
          <?php
                            $required_attr = '';
        ...
        <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ); ?> id="dokan_address[city]"
          value="<?php echo esc_attr( $address_city ); ?>" name="dokan_address[city]"
          placeholder="<?php esc_attr_e( 'Town / City', 'dokan-lite' ); ?>" class="dokan-form-control input-md"
          type="text">
      </div>
      <?php
                }
      ...
      <div class="dokan-form-group dokan-w5 dokan-left">
        <label class="control-label"
          for="dokan_address[zip]"><?php esc_html_e( 'Mã bưu điện/ Mã ZIP', 'dokan-lite' ); ?>
          <?php
                            $required_attr = '';
        ...
        <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ); ?> id="dokan_address[zip]"
          value="<?php echo esc_attr( $address_zip ); ?>" name="dokan_address[zip]"
          placeholder="<?php esc_attr_e( 'Postcode / Zip', 'dokan-lite' ); ?>" class="dokan-form-control input-md"
          type="text">
      </div>
      <?php } ?>
    ...
    <?php
        ...
        if ( $seller_address_fields['country'] ) {
            ...
            ?>
    <div class="dokan-form-group">
      <label class="control-label" for="dokan_address[country]"><?php esc_html_e( 'Quốc gia ', 'dokan-lite' ); ?>
        <?php
                    $required_attr = '';
      ...
      <select <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ); ?>
