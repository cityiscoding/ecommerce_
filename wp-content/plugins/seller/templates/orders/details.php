...
<div class="dokan-clearfix dokan-order-details-wrap">
  <div class="dokan-w8 dokan-order-left-content">
    ...
    <div class="dokan-clearfix">
      <div class="" style="width:100%">
        <div class="dokan-panel dokan-panel-default">
          <div class="dokan-panel-heading">
            <strong><?php printf( esc_html__( 'Order', 'dokan-lite' ) . '#%d', esc_attr( $order->get_id() ) ); ?></strong>
            &rarr; <?php esc_html_e( 'Các đơn đặt hàng', 'dokan-lite' ); ?>
          </div>
          <div class="dokan-panel-body" id="woocommerce-order-items">
            ...
            <table class="dokan-table order-items">
              <thead>
                <tr>
                  <th class="item" colspan="2"><?php esc_html_e( 'Item sản phẩm', 'dokan-lite' ); ?></th>

                  <?php do_action( 'woocommerce_admin_order_item_headers', $order ); ?>

                  <th class="quantity"><?php esc_html_e( 'Số lượng', 'dokan-lite' ); ?></th>

                  <th class="line_cost"><?php esc_html_e( 'Tổng', 'dokan-lite' ); ?></th>
                </tr>
              </thead>
            ...
            <table class="dokan-table order-items">
              <tr>
                <th><?php esc_html_e( 'Mã giảm giá', 'dokan-lite' ); ?></th>
                <td>
      ...
      <div class="dokan-left dokan-order-billing-address">
        <div class="dokan-panel dokan-panel-default">
          <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Địa chỉ thanh toán', 'dokan-lite' ); ?></strong>
          </div>
          <div class="dokan-panel-body">
            <?php
                        if ( $order->get_formatted_billing_address() ) {
                            ...
                            esc_html_e( 'Chưa đặt địa chỉ thanh toán.', 'dokan-lite' );
                        }
                        ?>
          </div>
        </div>
      ...
      <div class="dokan-left dokan-order-shipping-address">
        <div class="dokan-panel dokan-panel-default">
          <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Địa chỉ giao hàng', 'dokan-lite' ); ?></strong>
          </div>
          <div class="dokan-panel-body">
            <?php
                        if ( $order->get_formatted_shipping_address() ) {
                            ...
                            esc_html_e( 'Chưa đặt địa chỉ giao hàng.', 'dokan-lite' );
                        }
                        ?>
          </div>
        </div>
      ...
      <div class="" style="width: 100%">
        <div class="dokan-panel dokan-panel-default">
          <div class="dokan-panel-heading">
            <strong><?php esc_html_e( 'Giấy phép sản phẩm có thể tải xuống', 'dokan-lite' ); ?></strong>
          </div>
          <div class="dokan-panel-body">
            <?php
  ...
  <div class="dokan-w4 dokan-order-right-content">
    <div class="dokan-clearfix">
      <div class="" style="width:100%">
        <div class="dokan-panel dokan-panel-default">
          <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Chi tiết chung', 'dokan-lite' ); ?></strong>
          </div>
          <div class="dokan-panel-body general-details">
            <ul class="list-unstyled order-status">
              <li>
                <span><?php esc_html_e( 'Tình trạng đơn hàng:', 'dokan-lite' ); ?></span>
                <label
                  class="dokan-label dokan-label-<?php echo esc_attr( dokan_get_order_status_class( $order->get_status() ) ); ?>"><?php echo esc_html( dokan_get_order_status_translated( $order->get_status() ) ); ?></label>
                ...
                <a href="#"
                  class="dokan-edit-status"><small><?php esc_html_e( '&nbsp; Chỉnh sửa', 'dokan-lite' ); ?></small></a>
                <?php } ?>
              </li>
              <?php if ( current_user_can( 'dokan_manage_order' ) && dokan_get_option( 'order_status_change', 'dokan_selling', 'on' ) === 'on' && $order->get_status() !== 'cancelled' && $order->get_status() !== 'refunded' ) : ?>
              <li class="dokan-hide">
                <form id="dokan-order-status-form" action="" method="post">
                  ...
                  <input type="hidden" name="_wpnonce"
                    value="<?php echo esc_attr( wp_create_nonce( 'dokan_change_status' ) ); ?>">
                  <input type="submit" class="dokan-btn dokan-btn-success dokan-btn-sm" name="dokan_change_status"
                    value="<?php esc_attr_e( 'Cập nhật', 'dokan-lite' ); ?>">

                  <a href="#"
                    class="dokan-btn dokan-btn-default dokan-btn-sm dokan-cancel-status"><?php esc_html_e( 'Thoát', 'dokan-lite' ); ?></a>
                </form>
              </li>
              <?php endif ?>

              <li>
                <span><?php esc_html_e( 'Ngày đặt hàng:', 'dokan-lite' ); ?></span>
                <?php echo esc_html( dokan_get_date_created( $order ) ); ?>
              </li>
              <li class="earning-from-order">
                <span><?php esc_html_e( 'Thu nhập từ đơn hàng:', 'dokan-lite' ); ?></span>
            ...
            <ul class="list-unstyled customer-details">
              <li>
                <span><?php esc_html_e( 'Khách hàng:', 'dokan-lite' ); ?></span>
              ...
              <li>
                <span><?php esc_html_e( 'Số điện thoại:', 'dokan-lite' ); ?></span>
                <?php echo esc_html( $order->get_billing_phone() ); ?>
              </li>
              <li>
                <span><?php esc_html_e( 'IP khách hàng:', 'dokan-lite' ); ?></span>
                <a href="<?php echo esc_url( 'https://tools.keycdn.com/geo?host=' . $order->get_customer_ip_address() ); ?>"
                  target="_blank">
            ...
            <div class="alert alert-success customer-note">
              <strong><?php esc_html_e( 'Lưu ý của khách hàng:', 'dokan-lite' ); ?></strong><br>
      ...
      <div class="" style="width:100%">
        <div class="dokan-panel dokan-panel-default">
          <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Ghi chú đặt hàng', 'dokan-lite' ); ?></strong>
          </div>
          <div class="dokan-panel-body" id="dokan-order-notes">
            <?php
                        ...
                        if ( $notes ) {
                            foreach ( $notes as $note ) {
                                ...
                                ?>
            <li rel="<?php echo esc_attr( absint( $note->comment_ID ) ); ?>"
              ...
              <p class="meta">
                ...
                <a href="#" class="delete_note"><?php esc_html_e( 'Xóa ghi chú', 'dokan-lite' ); ?></a>
                <?php endif ?>
              </p>
            </li>
            <?php
            ...
            <div class="add_note">
              <?php if ( current_user_can( 'dokan_manage_order_note' ) ) : ?>
              <h4><?php esc_html_e( 'Thêm ghi chú', 'dokan-lite' ); ?></h4>
              <form class="dokan-form-inline" id="add-order-note" role="form" method="post">
                <p>
                  <textarea type="text" id="add-note-content" name="note" class="form-control" cols="19"
                    rows="3"></textarea>
                </p>
                <div class="clearfix">
                  <div class="order_note_type dokan-form-group">
                    <select name="note_type" id="order_note_type" class="dokan-form-control">
                      <option value="customer"><?php esc_html_e( 'Ghi chú của khách hàng', 'dokan-lite' ); ?></option>
                      <option value=""><?php esc_html_e( 'Ghi chú riêng', 'dokan-lite' ); ?></option>
                    </select>
                  </div>

                  <input type="hidden" name="security"
                    value="<?php echo esc_attr( wp_create_nonce( 'add-order-note' ) ); ?>">
                  <input type="hidden" name="delete-note-security" id="delete-note-security"
                    value="<?php echo esc_attr( wp_create_nonce( 'delete-order-note' ) ); ?>">
                  ...
                  <input type="submit" name="add_order_note" class="add_note btn btn-sm btn-theme dokan-btn-theme"
                    value="<?php esc_attr_e( 'Add Note', 'dokan-lite' ); ?>">
                </div>
              </form>
              <?php endif; ?>
              ...
              <div class="clearfix dokan-form-group" style="margin-top: 10px;">
                ...
                <input type="button" id="dokan-add-tracking-number" name="add_tracking_number"
                  class="dokan-btn dokan-btn-success" value="<?php esc_attr_e( 'Tracking Number', 'dokan-lite' ); ?>">

                <form id="add-shipping-tracking-form" method="post" class="dokan-hide" style="margin-top: 10px;">
                  <div class="dokan-form-group">
                    <label
                      class="dokan-control-label"><?php esc_html_e( 'Tên/URL nhà cung cấp vận chuyển', 'dokan-lite' ); ?></label>
                    <input type="text" name="shipping_provider" id="shipping_provider" class="dokan-form-control"
                      value="">
                  </div>

                  <div class="dokan-form-group">
                    <label
                      class="dokan-control-label"><?php esc_html_e( 'Mã theo dõi đơn hàng', 'dokan-lite' ); ?></label>
                    <input type="text" name="tracking_number" id="tracking_number" class="dokan-form-control" value="">
                  </div>

                  <div class="dokan-form-group">
                    <label class="dokan-control-label"><?php esc_html_e( 'Ngày giao hàng', 'dokan-lite' ); ?></label>
                    <input type="text" name="shipped_date" id="shipped-date" class="dokan-form-control" value=""
                      placeholder="<?php echo esc_attr( get_option( 'date_format' ) ); ?>">
                  </div>
                  <input type="hidden" name="security" id="security"
                    value="<?php echo esc_attr( wp_create_nonce( 'add-shipping-tracking-info' ) ); ?>">
                  ...
                  <div class="dokan-form-group">
                    <input id="add-tracking-details" type="button" class="btn btn-primary"
                      value="<?php esc_attr_e( 'Add Tracking Details', 'dokan-lite' ); ?>">
                    <button type="button" class="btn btn-default"
                      id="dokan-cancel-tracking-note"><?php esc_html_e( 'Đóng', 'dokan-lite' ); ?></button>
                  </div>
                </form>
              </div>
              <?php endif; ?>
