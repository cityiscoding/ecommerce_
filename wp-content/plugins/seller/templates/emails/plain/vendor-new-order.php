...
echo sprintf( esc_html__( 'Bạn đã nhận được một đơn đặt hàng từ %s.', 'dokan-lite' ), esc_html( $order->get_formatted_billing_full_name() ) ) . "\n\n";
echo "\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n\n";

esc_html_e( 'Sản phẩm            | Số lượng        | Giá', 'dokan-lite' );
echo "\n\n";
echo wp_kses_post(
