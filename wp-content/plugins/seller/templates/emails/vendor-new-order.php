...
<p>
  <?php
        ...
        printf( esc_html__( 'Bạn đã nhận được một đơn đặt hàng từ %s.', 'dokan-lite' ), esc_html( $order->get_formatted_billing_full_name() ) );
        ?>
</p>
    ...
    <thead>
      <tr>
        <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;">
          <?php esc_html_e( 'Sản phẩm', 'dokan-lite' ); ?></th>
        <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;">
          <?php esc_html_e( 'Số lượng', 'dokan-lite' ); ?></th>
        <th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;">
          <?php esc_html_e( 'Giá', 'dokan-lite' ); ?></th>
      </tr>
    </thead>
    <tbody>
      <?php
    ...
    <tfoot>
      ...
      <tr>
        <th class="td" scope="row" colspan="2" style="text-align:<?php echo esc_attr( $text_align ); ?>;">
          <?php esc_html_e( 'Ghi chú:', 'dokan-lite' ); ?></th>
