<div id="dokan-seller-listing-wrap" class="grid-view">
  <div class="seller-listing-content">
    ...
    <ul class="dokan-seller-wrap">
      ...
      <li
        class="dokan-single-seller woocommerce coloum-<?php echo esc_attr( $per_row ); ?> <?php echo ( ! $store_banner_id ) ? 'no-banner-img' : ''; ?>">
        <div class="store-wrapper">
          <div class="store-header">
            <div class="store-banner">
              <a href="<?php echo esc_url( $store_url ); ?>">
                <img
                  src="<?php echo is_array( $store_banner_url ) ? esc_attr( $store_banner_url[0] ) : esc_attr( $store_banner_url ); ?>">
              </a>
            </div>
          </div>
          ...
          <div class="store-content <?php echo ! $store_banner_id ? esc_attr( 'default-store-banner' ) : ''; ?>">
            <div class="store-data-container">
              <div class="featured-favourite">
                ...
                <div class="featured-label"><?php esc_html_e( 'Nổi bật', 'dokan-lite' ); ?></div>
                <?php endif ?>
              ...
              <span class="dokan-store-is-open-close-status dokan-store-is-open-status"
                title="<?php esc_attr_e( 'CC 1`21', 'dokan-lite' ); ?>"><?php esc_html_e( 'Mở', 'dokan-lite' ); ?></span>
              <?php } else { ?>
              <span class="dokan-store-is-open-close-status dokan-store-is-closed-status"
                title="<?php esc_attr_e( 'Store is Closed', 'dokan-lite' ); ?>"><?php esc_html_e( 'Đóng', 'dokan-lite' ); ?></span>
              <?php } ?>
              <?php endif ?>
              ...
              <div class="store-data <?php echo esc_attr( $store_open_is_on ); ?>">
                <h2><a href="<?php echo esc_attr( $store_url ); ?>"><?php echo esc_html( $store_name ); ?></a>
                  <?php do_action( 'dokan_store_list_loop_after_store_name', $vendor ); ?></h2>
            ...
            <div class="seller-avatar">
              <a href="<?php echo esc_url( $store_url ); ?>">
                <img src="<?php echo esc_url( $vendor->get_avatar() ); ?>"
                  alt="<?php echo esc_attr( $vendor->get_shop_name() ); ?>" size="150">
              </a>
            </div>
    ...
    <?php else : ?>
    <p class="dokan-error"><?php esc_html_e( 'Không tìm thấy kênh người bán nào!', 'dokan-lite' ); ?></p>
    <?php endif; ?>
  </div>
</div>