...
<form class="dokan-form-inline dokan-w8 dokan-product-date-filter" method="get">
  ...
  <div class="dokan-form-group">
    <select name="product_type" id="filter-by-type" class="dokan-form-control" style="max-width:140px;">
      <option value=""><?php esc_html_e( 'Loại sản phẩm', 'dokan-lite' ); ?></option>
  ...
  <div class="dokan-form-group">
    <button type="submit" class="dokan-btn"><?php esc_html_e( 'Lọc', 'dokan-lite' ); ?></button>
    <a class="dokan-btn"
      href="<?php echo esc_attr( dokan_get_navigation_url( 'products' ) ); ?>"><?php esc_html_e( 'Reset', 'dokan-lite' ); ?></a>
  </div>
</form>
...
<form method="get" class="dokan-form-inline dokan-w5 dokan-product-search-form">
  ...
  <button type="submit" name="product_listing_search" value="ok"
    class="dokan-btn dokan-btn-theme"><?php esc_html_e( 'Tìm kiếm', 'dokan-lite' ); ?></button>

  <?php wp_nonce_field( 'product_listing_filter', '_product_listing_filter_nonce', false ); ?>

  <div class="dokan-form-group">
    <input type="text" class="dokan-form-control" name="product_search_name"
      placeholder="<?php esc_html_e( 'Tìm kiếm sản phẩm', 'dokan-lite' ); ?>"
