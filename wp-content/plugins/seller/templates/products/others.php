...
<div class="dokan-other-options dokan-edit-row dokan-clearfix <?php echo esc_attr( $class ); ?>">
  <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
    <h2><i class="fas fa-cog" aria-hidden="true"></i> <?php esc_html_e( 'Tùy chọn khác', 'dokan-lite' ); ?></h2>
    <p><?php esc_html_e( 'Đặt tùy chọn sản phẩm bổ sung của bạn', 'dokan-lite' ); ?></p>
  ...
  <div class="dokan-section-content">
    <div class="dokan-form-group content-half-part">
      <label for="post_status" class="form-label"><?php esc_html_e( 'Trạng thái sản phẩm', 'dokan-lite' ); ?></label>
    ...
    <div class="dokan-form-group content-half-part">
      <label for="_visibility" class="form-label"><?php esc_html_e( 'Hiển thị', 'dokan-lite' ); ?></label>
    ...
    <div class="dokan-form-group">
      <label for="_purchase_note" class="form-label"><?php esc_html_e( 'Lưu ý mua hàng', 'dokan-lite' ); ?></label>
