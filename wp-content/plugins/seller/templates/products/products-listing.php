    ...
    <article class="dokan-product-listing-area">
        ...
        <form id="product-filter" method="POST" class="dokan-form-inline">
          ...
          <div id="dokan-bulk-action-submit" class="dokan-form-group">
            ...
            <input type="submit" name="bulk_product_status_change" id="bulk-product-action"
              class="dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Lưu', 'dokan-lite' ); ?>"
          ...
          <table class="dokan-table dokan-table-striped product-listing-table dokan-inline-editable-table"
            ...
            <thead>
              <tr>
                ...
                <th><?php esc_html_e( 'Ảnh', 'dokan-lite' ); ?></th>
                <th><?php esc_html_e( 'Tên', 'dokan-lite' ); ?></th>
                ...
                <th><?php esc_html_e( 'Hàng tồn kho', 'dokan-lite' ); ?></th>
                <th><?php esc_html_e( 'Giá', 'dokan-lite' ); ?></th>
                <th><?php esc_html_e( 'Loại', 'dokan-lite' ); ?></th>
                <th><?php esc_html_e( 'Lượt xem', 'dokan-lite' ); ?></th>
            ...
            <tbody>
              ...
              <?php
                                        ...
                                        if ( $product_query->have_posts() ) {
                                            ...
                                            ?>
              <tr>
                <td colspan="11"><?php esc_html_e( 'Không tìm thấy sản phẩm', 'dokan-lite' ); ?></td>
              </tr>
              <?php } ?>
            </tbody>
      ...
      <div class="dokan-dashboard-product-listing-wrapper dokan-dashboard-not-product-found">
        ...
        <h4 class="dokan-blank-product-message">
          <?php esc_html_e( 'Không tìm thấy sản phẩm!', 'dokan-lite' ); ?>
        </h4>

        <?php if ( dokan_is_seller_enabled( dokan_get_current_user_id() ) ) : ?>
        <h2 class="dokan-blank-product-message">
          <?php esc_html_e( 'Hãy tạo một sản phẩm mới trên kênh người bán của bạn', 'dokan-lite' ); ?>
        </h2>
