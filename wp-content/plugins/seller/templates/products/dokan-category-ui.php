  ...
  <div class="dokan-product-category-modal-content">
    <div class="dokan-product-category-modal-header">
      <div class="dokan-product-category-title">
        <span class="dokan-single-title"><?php esc_html_e( 'Thêm danh mục mới', 'dokan-lite' ); ?></span>
        <span
          class="dokan-single-des"><?php esc_html_e( 'Vui lòng chọn đúng danh mục cho sản phẩm này', 'dokan-lite' ); ?></span>
      </div>
    ...
    <div class="dokan-product-category-modal-body">
      <div class="dokan-category-search-container">
        <div class="dokan-cat-search-box">
          ...
          <input maxlength="100" id="dokan-single-cat-search-input" class="dokan-cat-search-input" type="text"
            placeholder="<?php esc_attr_e( 'Search category', 'dokan-lite' ); ?>">
          <span class="dokan-cat-search-text-limit"><span
              id="dokan-cat-search-text-limit"><?php echo number_format_i18n( 0 ); ?></span>/<?php echo number_format_i18n( 100 ); ?></span>
        </div>
    ...
    <div class="dokan-product-category-modal-footer">
      <div class="dokan-selected-category-label-container">
        <span class="dokan-selected-category-label"><?php esc_html_e( 'Đã chọn: ', 'dokan-lite' ); ?></span>
        <span class="dokan-selected-category-span" id="dokan-selected-category-span">
          <span class="dokan-selected-category-product"><?php esc_html_e( 'Không có danh mục', 'dokan-lite' ); ?></span>
        </span>
      </div>
      <div class="dokan-product-category-button-container">
        <button class="dokan-single-cat-select-btn dokan-btn dokan-btn-default dokan-btn-theme"
          id="dokan-single-cat-select-btn" type='button'><?php esc_html_e( 'Hoàn thành', 'dokan-lite' ); ?></button>
      </div>
    </div>
  </div>
