  ...
  <div class="dokan-dashboard-content">
    ...
    <header class="dokan-dashboard-header dokan-clearfix">
      <h1 class="entry-title">
        <?php esc_html_e( '+ Thêm sản phẩm mới', 'dokan-lite' ); ?>
      </h1>
    </header><!-- .entry-header -->
    ...
    <div class="dokan-new-product-area">
      ...
      <div class="dokan-alert dokan-alert-danger">
        ...
        <strong><?php esc_html_e( 'Lỗi!', 'dokan-lite' ); ?></strong> <?php echo wp_kses_post( $error_msg ); ?>.<br>
        <?php endforeach; ?>
      </div>
      <?php endif; ?>
      ...
      <form class="dokan-form-container" method="post">
        <div class="product-edit-container dokan-clearfix">
            ...
            <div class="featured-image">
              <div class="dokan-feat-image-upload">
                <div class="instruction-inside <?php echo esc_attr( $hide_instruction ); ?>">
                  ...
                  <a href="#"
                    class="dokan-feat-image-btn dokan-btn"><?php esc_html_e( 'Tải lên hình ảnh sản phẩm', 'dokan-lite' ); ?></a>
                </div>
                ...
                <div id="product_images_container">
                  <ul class="product_images dokan-clearfix">
                    ...
                    <li class="add-image add-product-images tips"
                      data-title="<?php esc_attr_e( 'Add gallery image', 'dokan-lite' ); ?>">
          ...
          <div class="content-half-part dokan-product-meta">
            <div class="dokan-form-group">
              <input class="dokan-form-control" name="post_title" id="post-title" type="text"
                placeholder="<?php esc_attr_e( 'Product name..', 'dokan-lite' ); ?>"
              ...
              <div class="dokan-form-group dokan-clearfix dokan-price-container">
                <div class="content-half-part">
                  <label for="_regular_price"
                    class="dokan-form-label"><?php esc_html_e( 'Giá', 'dokan-lite' ); ?></label>
                  <div class="dokan-input-group">
                    <span class="dokan-input-group-addon"><?php echo esc_attr( $currency_symbol ); ?></span>
                    <input type="text" class="dokan-form-control wc_input_price dokan-product-regular-price"
                      name="_regular_price" placeholder="0.00" id="_regular_price"
                ...
                <div class="content-half-part sale-price">
                  <label for="_sale_price" class="form-label">
                    ...
                    <a href="#" class="sale_schedule"><?php esc_html_e( 'Lịch trình giảm giá', 'dokan-lite' ); ?></a>
                    <a href="#" class="cancel_sale_schedule dokan-hide"><?php esc_html_e( 'Hủy', 'dokan-lite' ); ?></a>
                  </label>

                  <div class="dokan-input-group">
                    <span class="dokan-input-group-addon"><?php echo esc_attr( $currency_symbol ); ?></span>
                    <input type="text" class="dokan-form-control wc_input_price dokan-product-sales-price"
                      name="_sale_price" placeholder="0.00" id="_sale_price"
              ...
              <div class="dokan-hide sale-schedule-container sale_price_dates_fields dokan-clearfix dokan-form-group">
                <div class="content-half-part from">
                  <div class="dokan-input-group">
                    ...
                    <input type="text" name="_sale_price_dates_from"
                      class="dokan-form-control datepicker sale_price_dates_from" maxlength="10"
                      value="<?php echo esc_attr( $sale_price_date_from ); ?>"
                      pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])"
                      placeholder="<?php esc_attr_e( 'YYYY-MM-DD', 'dokan-lite' ); ?>">
                  </div>
                </div>
                ...
                <div class="content-half-part to">
                  <div class="dokan-input-group">
                    ...
                    <input type="text" name="_sale_price_dates_to"
                      class="dokan-form-control datepicker sale_price_dates_to"
                      value="<?php echo esc_attr( $sale_price_date_to ); ?>" maxlength="10"
                      pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])"
                      placeholder="<?php esc_attr_e( 'YYYY-MM-DD', 'dokan-lite' ); ?>">
                  </div>
                </div>
            ...
            <div class="dokan-form-group">
              <textarea name="post_excerpt" id="post-excerpt" rows="5" class="dokan-form-control"
                placeholder="<?php esc_attr_e( 'Short description of the product...', 'dokan-lite' ); ?>"><?php echo esc_attr( $post_excerpt ); ?></textarea>
            </div>
            ...
            <div class="dokan-form-group">
              <label for="product_tag" class="form-label"><?php esc_html_e( 'Thẻ', 'dokan-lite' ); ?></label>
              <select multiple="multiple" name="product_tag[]" id="product_tag_search"
                class="product_tag_search product_tags dokan-form-control dokan-select2"
                data-placeholder="<?php echo $can_create_tags ? esc_attr__( 'Select tags/Add tags', 'dokan-lite' ) : esc_attr__( 'Select product tags', 'dokan-lite' ); ?>">
                <?php if ( ! empty( $terms ) ) : ?>
                <?php foreach ( $terms as $product_term_id ) : ?>
                <?php $product_term = get_term( $product_term_id ); ?>
                <option value="<?php echo esc_attr( $product_term->term_id ); ?>" selected="selected">
                  <?php echo esc_html( $product_term->name ); ?></option>
                <?php endforeach ?>
                <?php endif ?>
              </select>
            </div>
        ...
        <div class="dokan-form-group">
          <label for="post_content"
            class="control-label"><?php esc_html_e( 'Mô tả chi tiết sản phẩm', 'dokan-lite' ); ?> <i
              class="fas fa-question-circle tips"
              data-title="<?php esc_attr_e( 'Add your product description', 'dokan-lite' ); ?>"
        ...
        <div class="dokan-form-group dokan-right">
          ...
          <?php endif; ?>
          <button type="submit" name="add_product" class="dokan-btn dokan-btn-default dokan-btn-theme"
            value="create_new"><?php esc_attr_e( 'Create Product', 'dokan-lite' ); ?></button>
        </div>
      </form>
      <?php else : ?>
