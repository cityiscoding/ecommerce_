...
<div class="dokan-clearfix dokan-panel-inner-container">
  <div class="dokan-w12">
    <strong><?php esc_html_e( 'Yêu cầu đang đợi giải quyết', 'dokan-lite' ); ?></strong>
    <table class="dokan-table dokan-table-striped">
      <tr>
        <th><?php esc_html_e( 'Số lượng', 'dokan-lite' ); ?></th>
        <th><?php esc_html_e( 'Phương thức', 'dokan-lite' ); ?></th>
        <th><?php esc_html_e( 'Ngày', 'dokan-lite' ); ?></th>
        <th><?php esc_html_e( 'Phí', 'dokan-lite' ); ?></th>
        <th><?php esc_html_e( 'Tiền phải thu', 'dokan-lite' ); ?></th>
        <th><?php esc_html_e( 'Hủy', 'dokan-lite' ); ?></th>
