...
<div class="dokan-form-horizontal withdraw" id="dokan-handle-withdraw-request">
  <div class="dokan-form-group">
    <label for="withdraw-method" class="dokan-w4 dokan-control-label">
      <?php esc_html_e( 'Phương thức rút tiền', 'dokan-lite' ); ?>
    </label>
    <div class="dokan-w5 dokan-text-left">
      <select class="dokan-form-control" required name="withdraw_method" id="withdraw-method">
        ...
        <?php
                        ...
                        ?>
        <option data-charge-fixed="<?php echo esc_attr( $fixed_charge ); ?>"
          data-charge-percentage="<?php echo esc_attr( $percentage_charge ); ?>"
          value="<?php echo esc_attr( $method_name ); ?>" <?php selected( $withdraw_method, $method_name ); ?>>
  ...
  <div class="dokan-form-group">
    <label for="withdraw-amount" class="dokan-w4 dokan-control-label">
      <?php esc_html_e( 'Số tiền rút', 'dokan-lite' ); ?>
    </label>

    <div class="dokan-w5 dokan-text-left">
      <div class="dokan-input-group">
        <span class="dokan-input-group-addon"><?php echo esc_html( get_woocommerce_currency_symbol() ); ?></span>
        <input name="withdraw_amount" required class="wc_input_price dokan-form-control" id="withdraw-amount"
          type="text" placeholder="0<?php echo esc_attr( wc_get_price_decimal_separator() ); ?>00"
          value="<?php echo esc_attr( wc_format_localized_price( $amount ) ); ?>">
      </div>
    </div>
  </div>
  ...
  <div class="dokan-form-group" id="dokan-withdraw-charge-section">
    <label for="withdraw-method" class="dokan-w4 dokan-control-label">
      <?php esc_html_e( 'Phí rút tiền', 'dokan-lite' ); ?>
    </label>
    <div class="dokan-w5 dokan-text-left">
  ...
  <div class="dokan-form-group" id="dokan-withdraw-revivable-section">
    <label for="withdraw-method" class="dokan-w4 dokan-control-label">
      <?php esc_html_e( 'Tổng số bạn tiền nhận được', 'dokan-lite' ); ?>
    </label>
    <div class="dokan-w5 dokan-text-left">
  ...
  <div class="dokan-form-group">
    <div class="ajax_prev footer">
      ...
      <button type="submit" id="dokan-withdraw-request-submit"
        class="dokan-btn dokan-btn-theme"><?php esc_html_e( 'Gữi yêu cầu', 'dokan-lite' ); ?></button>
