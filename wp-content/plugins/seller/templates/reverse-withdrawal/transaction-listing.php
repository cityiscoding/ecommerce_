...
<table class="dokan-table dokan-table-striped">
  <tr>
    <th><?php esc_html_e( 'ID giao dịch', 'dokan-lite' ); ?></th>
    <th><?php esc_html_e( 'Ngày', 'dokan-lite' ); ?></th>
    <th><?php esc_html_e( 'Loại giao dịch', 'dokan-lite' ); ?></th>
    <th><?php esc_html_e( 'Ghi chú', 'dokan-lite' ); ?></th>
    <th><?php esc_html_e( 'Debit', 'dokan-lite' ); ?></th>
    <th><?php esc_html_e( 'Credit', 'dokan-lite' ); ?></th>
    <th><?php esc_html_e( 'Số dư', 'dokan-lite' ); ?></th>
  </tr>
  <?php
        // get current balance
        $current_balance = 0;
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td><b><?php esc_html_e( 'Số dư:', 'dokan-lite' ); ?></b></td>
  ...
  <tr>
    <td colspan="7">
      <?php esc_html_e( 'Không tìm thấy giao dịch nào!', 'dokan-lite' ); ?>
    </td>
  </tr>
  <?php
        }
