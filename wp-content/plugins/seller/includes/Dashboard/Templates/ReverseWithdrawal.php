...
class ReverseWithdrawal {
    ...
    public function display_action_taken_notice() {
        ...
        $message = sprintf(
            ...
            __( 'Các hành động dưới đây đã được thực hiện do số dư rút tiền ngược không thanh toán: %1$s Vui lòng <a href="%2$s"> thanh toán phí rút tiền ngược cho quản trị viên </a> để bắt đầu bán lại.', 'dokan-lite' ),
