...
<div class="dokan-form-group">
  <div class="dokan-w8">
    <div class="dokan-input-group">
      ...
      <input value="<?php echo esc_attr( $email ); ?>" name="settings[paypal][email]" class="dokan-form-control email"
        placeholder="aido@gmail.com" type="text">
    </div>
  </div>
</div>
...
<div class="dokan-form-group">
  <div class="dokan-w8">
    ...
    <button
      class="ajax_prev disconnect dokan_payment_disconnect_btn dokan-btn dokan-btn-danger <?php echo empty( $email ) ? 'dokan-hide' : ''; ?>"
      type="button" name="settings[paypal][disconnect]">
...
<div class="dokan-form-group">
  <div class="dokan-w8">
    <div class="dokan-input-group">
      <span class="dokan-input-group-addon"><?php esc_html_e( 'E-mail', 'dokan-lite' ); ?></span>
      <input value="<?php echo esc_attr( $email ); ?>" name="settings[skrill][email]" class="dokan-form-control email"
...
function dokan_bank_payment_fields_placeholders() {
    return apply_filters(
        ...
        [
            'ac_type'  => [
                'label'       => __( 'Loại tài khoản', 'dokan-lite' ),
                'placeholder' => __( 'Lựa chọn loại tài khoản', 'dokan-lite' ),
            ],
            'ac_name'  => [
                'label'       => __( 'Tên tài khoản', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: TRAN THANH PHO', 'dokan-lite' ),
            ],
                        'ac_number' => [
                'label'       => __( 'Số tài khoản', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: 0857332962', 'dokan-lite' ),
            ],
            'bank_name' => [
                'label'       => __( 'Tên ngân hàng', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: MB BANK', 'dokan-lite' ),
            ],
            'routing_number' => [
                'label'       => __( 'Số định tuyến (Không bắt buộc)', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: 123456789', 'dokan-lite' ),
            ],

            'bank_addr' => [
                'label'       => __( 'Địa chỉ ngân hàng gần nhất (Không bắt buộc)', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: Phường 5 Thành Phố Cà Mau', 'dokan-lite' ),
            ],
            'iban' => [
                'label'       => __( 'Mã IBAN (Không bắt buộc)', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: GB1234...', 'dokan-lite' ),
            ],
            'swift' => [
                'label'       => __( 'Mã Swift Code (Không bắt buộc)', 'dokan-lite' ),
                'placeholder' => __( 'Ví dụ: SWIFT Code MB Bank là: MSCBVNVX', 'dokan-lite' ),
            ],
            'declaration' => [
                'label'       => __( 'Tôi đảm bảo rằng tôi là chủ sở hữu và có toàn quyền đối với tài khoản ngân hàng này. Mọi hậu quả khi cố tình nhập sai tài khoản PallMall hoàn toàn không chịu trách nhiệm!', 'dokan-lite' ),
                'placeholder' => __( '', 'dokan-lite' ), // phpcs:ignore
            ],
            'form_caution' => [
                'label'       => __( 'Vui lòng kiểm tra lại thông tin tài khoản của bạn!', 'dokan-lite' ),
                'placeholder' => __( 'Tên tài khoản và số không chính xác hoặc không phù hợp có thể dẫn đến sự chậm trễ và phí rút tiền', 'dokan-lite' ),
            ],
        ]
    );
}
