...
function dokan_post_input_box( $post_id, $meta_key, $attr = [], $type = 'text' ) {
    ...
    switch ( $type ) {
        case 'text':
            ?>
<input <?php echo esc_attr( $required ); ?> type="text" name="<?php echo esc_attr( $name ); ?>"
  id="<?php echo esc_attr( $name ); ?>" value="<?php echo esc_attr( $value ); ?>"
  class="<?php echo esc_attr( $class ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>">
<?php
            break;
        ...
        case 'price':
            ?>
<input <?php echo esc_attr( $required ); ?> type="text" name="<?php echo esc_attr( $name ); ?>"
  id="<?php echo esc_attr( $name ); ?>" value="<?php echo esc_attr( wc_format_localized_price( $value ) ); ?>"
  class="wc_input_price <?php echo esc_attr( $class ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>">
<?php
            break;
...
<input <?php echo esc_attr( $required ); ?> type="text" name="<?php echo esc_attr( $name ); ?>"
  id="<?php echo esc_attr( $name ); ?>" value="<?php echo esc_attr( wc_format_localized_price( $value ) ); ?>"
  class="wc_input_decimal <?php echo esc_attr( $class ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>">
<?php
            break;
        ...
        case 'textarea':
            ...
            ?>
<textarea <?php echo esc_attr( $required ); ?> name="<?php echo esc_attr( $name ); ?>"
  id="<?php echo esc_attr( $name ); ?>" rows="<?php echo esc_attr( $rows ); ?>"
...
<label class="<?php echo esc_attr( $class ); ?>" for="<?php echo esc_attr( $name ); ?>">
  ...
  <input <?php echo esc_attr( $required ); ?> name="<?php echo esc_attr( $name ); ?>"
    id="<?php echo esc_attr( $name ); ?>" value="yes" type="checkbox" <?php checked( $value, 'yes' ); ?>>
...
<?php
        ...
        case 'number':
            ...
            ?>
<input <?php echo esc_attr( $required ); ?> type="number" name="<?php echo esc_attr( $name ); ?>"
  id="<?php echo esc_attr( $name ); ?>" value="<?php echo esc_attr( $value ); ?>"
  class="<?php echo esc_attr( $class ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>"
  min="<?php echo esc_attr( $min ); ?>" step="<?php echo esc_attr( $step ); ?>" size="<?php echo esc_attr( $size ); ?>">
<?php
            break;
...
<label class="<?php echo esc_attr( $class ); ?>" for="<?php echo esc_attr( $key ); ?>">
  <input name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $key ); ?>"
    value="<?php echo esc_attr( $key ); ?>" type="radio" <?php checked( $value, $key ); ?>>
  <?php echo esc_html( $label ); ?>
</label>
...
function dokan_country_dropdown( $options, $selected = '', $everywhere = false ) {
    printf( '<option value="">%s</option>', esc_html__( '-- Lựa chọn quốc gia --', 'dokan-lite' ) );
...
function dokan_state_dropdown( $options, $selected = '', $everywhere = false ) {
    printf( '<option value="">%s</option>', esc_html__( '-- Lựa chọn tiểu ban (Nếu quốc gia khác Việt Nam --)', 'dokan-lite' ) );
...
function dokan_get_shipping_processing_times() {
    $times = [
        ''  => __( 'Sẵn sàng giao hàng', 'dokan-lite' ),
        '1' => __( '1 ngày làm việc', 'dokan-lite' ),
        '2' => __( '1-2 ngày làm việc', 'dokan-lite' ),
        '3' => __( '1-3 ngày làm việc', 'dokan-lite' ),
        '4' => __( '3-5 ngày làm việc', 'dokan-lite' ),
        '5' => __( '1-2 tuần', 'dokan-lite' ),
        '6' => __( '2-3 tuần', 'dokan-lite' ),
        '7' => __( '3-4 tuần', 'dokan-lite' ),
        '8' => __( '4-6 tuần', 'dokan-lite' ),
        '9' => __( '6-8 tuần', 'dokan-lite' ),
    ];
...
//hide edit shiping:
add_action('wp_footer', 'custom_admin_order_status_scripttt');

function custom_admin_order_status_scripttt() {
    ?>
...
//hide help 3
add_action('admin_footer', 'hide_dokan_helps5_content');
function hide_dokan_helps5_content() {if (is_admin())
    ?>
<style>
.help-text {
