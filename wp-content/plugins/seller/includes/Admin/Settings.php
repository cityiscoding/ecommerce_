    ...
    public function get_settings_sections() {
        $sections = [
            ...
            [
                ...
                'document_link'        => 'https://pallmall.shop',
                'settings_title'       => __( 'Cài đặt rút tiền ngược cho ADMIN', 'dokan-lite' ),
        ...
        $general_site_options = apply_filters(
            'dokan_settings_general_site_options', [
                ...
                'setup_wizard_message'   => [
                    ...
                    'type'    => 'wpeditor',
                    'default' => __( 'Cảm ơn bạn đã chọn PallMall.Shop để tạo cửa hàng trực tuyến của bạn! Trình hướng dẫn thiết lập nhanh này sẽ giúp bạn cấu hình các cài đặt cơ bản cửa hàng. <strong>Việc này hoàn toàn không bắt buộc và không mất quá hai phút.</strong>', 'dokan-lite' ),
                ],
            ...
            'dokan_appearance' => [
                ...
                'recaptcha_validation_label' => [
                    ...
                    /* translators: 1) Opening anchor tag, 2) Closing anchor tag, 3) Opening anchor tag, 4) Closing anchor tag */
                        ...
                        '</a>',
                        '<a href="https://pallmall.shop/recaptcha" target="_blank" rel="noopener noreferrer">',
                        '</a>'
                    ),
                    'label'                => __( 'Xác thực reCAPTCHA của Google', 'dokan-lite' ),
                    'icon_url'             => DOKAN_PLUGIN_ASSEST . '/images/google.svg',
                    'social_desc'          => __( 'Bạn có thể kết nối thành công với tài khoản Google Recaptcha của mình từ đây.', 'dokan-lite' ),
                    'enable_status'        => [
