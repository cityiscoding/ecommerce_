...
class Hooks {
    ...
    public function handle_order_notes_for_suborder( $order ) {
        ...
        foreach ( $notes as $note ) {
            ...
            if ( false !== strpos( $note->content, __( 'Mức tồn kho giảm:', 'woocommerce' ) ) ) { //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
        ...
        foreach ( $order->get_items( 'line_item' ) as $key => $line_item ) {
            ...
            if ( $product->get_manage_stock() ) {
                ...
                $order->add_order_note( __( 'Mức tồn kho giảm:', 'woocommerce' ) . ' ' . $notes_content ); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
            }
        }
    }
