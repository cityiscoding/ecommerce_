  ...
  <label class="alignleft">
    ...
    <span class="input-text-wrap">
      <select name="dokan_product_author_override" id="dokan_product_author_override">
        ...
        <option value="<?php echo esc_attr( $admin_user->ID ); ?>"><?php echo esc_html( $admin_user->display_name ); ?>
        </option>
        <?php else : ?>
        ...
        <option value="<?php echo esc_attr( $vendor->get_id() ); ?>">
          <?php echo ! empty( $vendor->get_shop_name() ) ? esc_html( $vendor->get_shop_name() ) : esc_html( $vendor->get_name() ); ?>
        </option>
        <?php endforeach ?>
        <?php endif ?>
      </select>
...
(function($) {
  $('#the-list').on('click', '.editinline', function() {
    ...
    $('select[name="dokan_product_author_override"] option', '.inline-edit-row').attr('selected', false).trigger(
      'change');
    $('select[name="dokan_product_author_override"] option[value="' + $vendor_id_inline_data + '"]').attr(
