...
class SettingsHelper {
    ...
    public static function get_failed_payment_actions() {
        $actions = [
            'enable_catalog_mode' => esc_html__( 'Tắt nút thêm vào nút giỏ hàng', 'dokan-lite' ),
            'hide_withdraw_menu'  => esc_html__( 'Ẩn menu rút tiền', 'dokan-lite' ),
            'status_inactive'     => esc_html__( 'Làm cho trạng thái nhà cung cấp không hoạt động', 'dokan-lite' ),
        ];
